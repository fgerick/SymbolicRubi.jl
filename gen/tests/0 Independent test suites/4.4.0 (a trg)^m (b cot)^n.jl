# line nr: 15
@test integrate(Power(tan(d + e*x), 2)*Power(Power(a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4), 3Power(2, -1)), -1), x) == (c*(b - 2c)*Power(tan(d + e*x), 2) + Power(b, 2) - 2a*c - b*c)*tan(d + e*x)*Power(e*(Power(b, 2) - 4a*c)*(a + c - b)*Sqrt(a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4)), -1) + (Sqrt(c)*Power(tan(d + e*x), 2) + Sqrt(a))*Sqrt((a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4))*Power(Power(Sqrt(c)*Power(tan(d + e*x), 2) + Sqrt(a), 2), -1))*Power(c, Power(4, -1))*EllipticF(2atan(tan(d + e*x)*Power(c, Power(4, -1))*Power(Power(a, Power(4, -1)), -1)), (2 - b*Power(Sqrt(a)*Sqrt(c), -1))*Power(4, -1))*Power(2e*(Sqrt(a) - Sqrt(c))*(a + c - b)*Sqrt(a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4))*Power(a, Power(4, -1)), -1) + (b - 2c)*(Sqrt(c)*Power(tan(d + e*x), 2) + Sqrt(a))*Sqrt((a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4))*Power(Power(Sqrt(c)*Power(tan(d + e*x), 2) + Sqrt(a), 2), -1))*Power(a, Power(4, -1))*Power(c, Power(4, -1))*EllipticE(2atan(tan(d + e*x)*Power(c, Power(4, -1))*Power(Power(a, Power(4, -1)), -1)), (2 - b*Power(Sqrt(a)*Sqrt(c), -1))*Power(4, -1))*Power(e*(Power(b, 2) - 4a*c)*(a + c - b)*Sqrt(a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4)), -1) - atan(tan(d + e*x)*Sqrt(a + c - b)*Power(Sqrt(a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4)), -1))*Power(2e*Power(a + c - b, 3Power(2, -1)), -1) - (Sqrt(c)*Power(tan(d + e*x), 2) + Sqrt(a))*(Sqrt(a) + Sqrt(c))*EllipticPi(-Power(Sqrt(a) - Sqrt(c), 2)*Power(4Sqrt(a)*Sqrt(c), -1), 2atan(tan(d + e*x)*Power(c, Power(4, -1))*Power(Power(a, Power(4, -1)), -1)), (2 - b*Power(Sqrt(a)*Sqrt(c), -1))*Power(4, -1))*Sqrt((a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4))*Power(Power(Sqrt(c)*Power(tan(d + e*x), 2) + Sqrt(a), 2), -1))*Power(4e*(Sqrt(a) - Sqrt(c))*(a + c - b)*Sqrt(a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4))*Power(a, Power(4, -1))*Power(c, Power(4, -1)), -1) - (b - 2c)*Sqrt(c)*tan(d + e*x)*Sqrt(a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4))*Power(e*(Sqrt(c)*Power(tan(d + e*x), 2) + Sqrt(a))*(Power(b, 2) - 4a*c)*(a + c - b), -1) - (Sqrt(a) - Sqrt(c))*(Sqrt(c)*Power(tan(d + e*x), 2) + Sqrt(a))*Sqrt((a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4))*Power(Power(Sqrt(c)*Power(tan(d + e*x), 2) + Sqrt(a), 2), -1))*Power(c, Power(4, -1))*EllipticF(2atan(tan(d + e*x)*Power(c, Power(4, -1))*Power(Power(a, Power(4, -1)), -1)), (2 - b*Power(Sqrt(a)*Sqrt(c), -1))*Power(4, -1))*Power(2e*(b - 2Sqrt(a)*Sqrt(c))*(a + c - b)*Sqrt(a + b*Power(tan(d + e*x), 2) + c*Power(tan(d + e*x), 4))*Power(a, Power(4, -1)), -1)
