# line nr: 15
@test integrate((A + B*tan(e + f*x) + C*Power(tan(e + f*x), 2))*Power(a + b*tan(e + f*x), m)*Power(Power(c + d*tan(e + f*x), 3), -1), x) == (A*Power(d, 2) + C*Power(c, 2) - B*c*d)*Power(a + b*tan(e + f*x), 1 + m)*Power(f*(2b*c - 2a*d)*(Power(c, 2) + Power(d, 2))*Power(c + d*tan(e + f*x), 2), -1) + (A + B*I - C)*Hypergeometric2F1(1, 1 + m, 2 + m, (a + b*tan(e + f*x))*Power(a + I*b, -1))*Power(a + b*tan(e + f*x), 1 + m)*Power(f*(1 + m)*(2a + 2I*b)*Power(I*c - d, 3), -1) + (A - C - B*I)*Hypergeometric2F1(1, 1 + m, 2 + m, (a + b*tan(e + f*x))*Power(a - I*b, -1))*Power(a + b*tan(e + f*x), 1 + m)*Power(f*(1 + m)*(2b + 2I*a)*Power(c - I*d, 3), -1) + (2(d*(A - C)*(3Power(c, 2) - Power(d, 2)) - B*(Power(c, 3) - 3c*Power(d, 2)))*Power(a, 2)*Power(d, 3) - (A*(m*(1 - m)*Power(d, 4) + 2(1 + 3m - Power(m, 2))*Power(c, 2)*Power(d, 2) - (6 + Power(m, 2) - 5m)*Power(c, 4))*Power(d, 2) + C*(m*(1 - m)*Power(c, 4) + 2(3 - m - Power(m, 2))*Power(c, 2)*Power(d, 2) - (2 + 3m + Power(m, 2))*Power(d, 4))*Power(c, 2) + B*c*d*((2 + Power(m, 2) - 3m)*Power(c, 4) + m*(1 + m)*Power(d, 4) - 2(3 + m - Power(m, 2))*Power(c, 2)*Power(d, 2)))*Power(b, 2) - 2a*b*(B*(6Power(c, 2)*Power(d, 2) - (2 - m)*Power(c, 4) - m*Power(d, 4)) + 2c*d*(A - C)*((3 - m)*Power(c, 2) - (1 + m)*Power(d, 2)))*Power(d, 2))*Hypergeometric2F1(1, 1 + m, 2 + m, -d*(a + b*tan(e + f*x))*Power(b*c - a*d, -1))*Power(a + b*tan(e + f*x), 1 + m)*Power(2f*(1 + m)*Power(b*c - a*d, 3)*Power(Power(c, 2) + Power(d, 2), 3), -1) - (2a*(2c*d*(A - C) - B*(Power(c, 2) - Power(d, 2)))*Power(d, 2) - b*(A*(1 - m)*Power(d, 4) + C*(1 - m)*Power(c, 4) + (A*(5 - m) - C*(3 + m))*Power(c, 2)*Power(d, 2) + B*c*(1 + m)*Power(d, 3) - B*d*(3 - m)*Power(c, 3)))*Power(a + b*tan(e + f*x), 1 + m)*Power(2f*(c + d*tan(e + f*x))*Power(b*c - a*d, 2)*Power(Power(c, 2) + Power(d, 2), 2), -1)
