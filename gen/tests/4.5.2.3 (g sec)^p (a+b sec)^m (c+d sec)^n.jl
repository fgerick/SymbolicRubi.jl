...
# line nr: 673
@test integrate(sec(e + f*x)*Power(tan(e + f*x), 4)*Power(Power(c - c*sec(e + f*x), 8), -1), x) == Power(24f*Power(c, 8), -1)*Power(cot((e + f*x)*Power(2, -1)), 9) + Power(40f*Power(c, 8), -1)*Power(cot((e + f*x)*Power(2, -1)), 5) - 3Power(56f*Power(c, 8), -1)*Power(cot((e + f*x)*Power(2, -1)), 7) - Power(88f*Power(c, 8), -1)*Power(cot((e + f*x)*Power(2, -1)), 11)
