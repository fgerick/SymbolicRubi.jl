...
# line nr: 1394
@test integrate(Power(c*Power(d*sin(e + f*x), p), n)*Power(Power(a + b*sin(e + f*x), 3), -1), x) == cos(e + f*x)*AppellF1(Power(2, -1), (-2 - n*p)*Power(2, -1), 3, 3Power(2, -1), Power(cos(e + f*x), 2), -Power(b, 2)*Power(Power(a, 2) - Power(b, 2), -1)*Power(cos(e + f*x), 2))*Power(b, 3)*Power(c*Power(d*sin(e + f*x), p), n)*Power(f*Power(Power(a, 2) - Power(b, 2), 3)*Power(Power(sin(e + f*x), 2), n*p*Power(2, -1)), -1) + 3b*cos(e + f*x)*AppellF1(Power(2, -1), -n*p*Power(2, -1), 3, 3Power(2, -1), Power(cos(e + f*x), 2), -Power(b, 2)*Power(Power(a, 2) - Power(b, 2), -1)*Power(cos(e + f*x), 2))*Power(a, 2)*Power(c*Power(d*sin(e + f*x), p), n)*Power(f*Power(Power(a, 2) - Power(b, 2), 3)*Power(Power(sin(e + f*x), 2), n*p*Power(2, -1)), -1) - cot(e + f*x)*AppellF1(Power(2, -1), (1 - n*p)*Power(2, -1), 3, 3Power(2, -1), Power(cos(e + f*x), 2), -Power(b, 2)*Power(Power(a, 2) - Power(b, 2), -1)*Power(cos(e + f*x), 2))*Power(a, 3)*Power(c*Power(d*sin(e + f*x), p), n)*Power(f*Power(Power(a, 2) - Power(b, 2), 3), -1)*Power(Power(sin(e + f*x), 2), (1 - n*p)*Power(2, -1)) - 3a*cos(e + f*x)*sin(e + f*x)*AppellF1(Power(2, -1), (-1 - n*p)*Power(2, -1), 3, 3Power(2, -1), Power(cos(e + f*x), 2), -Power(b, 2)*Power(Power(a, 2) - Power(b, 2), -1)*Power(cos(e + f*x), 2))*Power(b, 2)*Power(c*Power(d*sin(e + f*x), p), n)*Power(f*Power(Power(a, 2) - Power(b, 2), 3), -1)*Power(Power(sin(e + f*x), 2), (-1 - n*p)*Power(2, -1))
