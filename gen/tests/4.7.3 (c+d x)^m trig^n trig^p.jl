...
# line nr: 749
@test integrate(x*cos(2x)*Power(sec(x), 3), x) == sec(x)*Power(2, -1) + 3I*PolyLog(2, -I*Power(E, I*x))*Power(2, -1) - 3I*x*atan(Power(E, I*x)) - 3I*PolyLog(2, I*Power(E, I*x))*Power(2, -1) - x*sec(x)*tan(x)*Power(2, -1)
