...
# line nr: 913
@test integrate(Power(b*csc(e + f*x), n)*Power(a*sin(e + f*x), m), x) == cos(e + f*x)*Hypergeometric2F1(Power(2, -1), (1 + m - n)*Power(2, -1), (3 + m - n)*Power(2, -1), Power(sin(e + f*x), 2))*Power(b*csc(e + f*x), n)*Power(a*sin(e + f*x), 1 + m)*Power(a*f*(1 + m - n)*Sqrt(Power(cos(e + f*x), 2)), -1)
