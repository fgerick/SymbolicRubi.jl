...
# line nr: 264
@test integrate(Power(x, 0)*Power(Power(a + b*asinh(c*x), 7Power(2, -1)), -1), x) == 4Sqrt(Pi)*Erfi(Sqrt(a + b*asinh(c*x))*Power(Sqrt(b), -1))*Power(15c*Power(E, a*Power(b, -1))*Power(b, 7Power(2, -1)), -1) - 4x*Power(15Power(b, 2)*Power(a + b*asinh(c*x), 3Power(2, -1)), -1) - 8Sqrt(1 + Power(c, 2)*Power(x, 2))*Power(15c*Sqrt(a + b*asinh(c*x))*Power(b, 3), -1) - 2Sqrt(1 + Power(c, 2)*Power(x, 2))*Power(5b*c*Power(a + b*asinh(c*x), 5Power(2, -1)), -1) - 4Sqrt(Pi)*Erf(Sqrt(a + b*asinh(c*x))*Power(Sqrt(b), -1))*Power(E, a*Power(b, -1))*Power(15c*Power(b, 7Power(2, -1)), -1)
