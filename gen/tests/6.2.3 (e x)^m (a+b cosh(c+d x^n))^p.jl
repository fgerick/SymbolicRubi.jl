...
# line nr: 165
@test integrate(cosh(a + b*Power(c + d*x, Power(3, -1)))*Power(Power(x, 2), -1), x) == b*d*sinh(a + b*Power(c, Power(3, -1)))*CoshIntegral(b*(Power(c, Power(3, -1)) - Power(c + d*x, Power(3, -1))))*Power(3Power(c, 2Power(3, -1)), -1) + b*d*sinh(a + b*Power(c, Power(3, -1))*Power(-1, 2Power(3, -1)))*CoshIntegral(-b*(Power(c, Power(3, -1))*Power(-1, 2Power(3, -1)) - Power(c + d*x, Power(3, -1))))*Power(-1, 2Power(3, -1))*Power(3Power(c, 2Power(3, -1)), -1) - cosh(a + b*Power(c + d*x, Power(3, -1)))*Power(x, -1) - b*d*cosh(a + b*Power(c, Power(3, -1)))*SinhIntegral(b*(Power(c, Power(3, -1)) - Power(c + d*x, Power(3, -1))))*Power(3Power(c, 2Power(3, -1)), -1) - b*d*cosh(a + b*Power(c, Power(3, -1))*Power(-1, 2Power(3, -1)))*SinhIntegral(b*(Power(c, Power(3, -1))*Power(-1, 2Power(3, -1)) - Power(c + d*x, Power(3, -1))))*Power(-1, 2Power(3, -1))*Power(3Power(c, 2Power(3, -1)), -1) - b*d*sinh(a - b*Power(c, Power(3, -1))*Power(-1, Power(3, -1)))*CoshIntegral(b*(Power(c, Power(3, -1))*Power(-1, Power(3, -1)) + Power(c + d*x, Power(3, -1))))*Power(3Power(c, 2Power(3, -1)), -1)*Power(-1, Power(3, -1)) - b*d*cosh(a - b*Power(c, Power(3, -1))*Power(-1, Power(3, -1)))*SinhIntegral(b*(Power(c, Power(3, -1))*Power(-1, Power(3, -1)) + Power(c + d*x, Power(3, -1))))*Power(3Power(c, 2Power(3, -1)), -1)*Power(-1, Power(3, -1))
