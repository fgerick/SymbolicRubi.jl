...
# line nr: 66
@test integrate(atan(x)*Log(x)*Power(x, -1), x) == I*Power(2, -1)*PolyLog(3, I*x) + I*Log(x)*PolyLog(2, -I*x)*Power(2, -1) - I*Power(2, -1)*PolyLog(3, -I*x) - I*Log(x)*PolyLog(2, I*x)*Power(2, -1)
