...
# line nr: 621
@test integrate((d + e*Log(f*Power(x, m)))*(a + b*atanh(c*Power(x, n)))*Power(x, -1), x) == a*d*Log(x) + b*d*Power(2n, -1)*PolyLog(2, c*Power(x, n)) + a*e*Power(2m, -1)*Power(Log(f*Power(x, m)), 2) + b*e*m*Power(2Power(n, 2), -1)*PolyLog(3, -c*Power(x, n)) + b*e*Log(f*Power(x, m))*Power(2n, -1)*PolyLog(2, c*Power(x, n)) - b*d*Power(2n, -1)*PolyLog(2, -c*Power(x, n)) - b*e*m*Power(2Power(n, 2), -1)*PolyLog(3, c*Power(x, n)) - b*e*Log(f*Power(x, m))*Power(2n, -1)*PolyLog(2, -c*Power(x, n))
