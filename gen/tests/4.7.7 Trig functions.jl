...
# line nr: 1822
@test integrate((Power(sec(a + b*x), 4) - Power(csc(a + b*x), 4))*Power(Power(csc(a + b*x), 4) + Power(sec(a + b*x), 4), -1), x) == Log(1 + Power(tan(a + b*x), 2) - tan(a + b*x)*Sqrt(2))*Power(2b*Sqrt(2), -1) - Log(1 + tan(a + b*x)*Sqrt(2) + Power(tan(a + b*x), 2))*Power(2b*Sqrt(2), -1)
