...
{1/((c + d*x)*(2*c^3 + d^3*x^3)^(2/3)), x, 1, -(ArcTan[(1 + (2*d*x)/(2*c^3 + d^3*x^3)^(1/3))/Sqrt[3]]/(2*Sqrt[3]*c^2*d)) + (Sqrt[3]*ArcTan[(1 + (2*(2*c + d*x))/(2*c^3 + d^3*x^3)^(1/3))/Sqrt[3]])/(2*c^2*d) - Log[c + d*x]/(2*c^2*d) - Log[d*x - (2*c^3 + d^3*x^3)^(1/3)]/(4*c^2*d) + (3*Log[d*(2*c + d*x) - d*(2*c^3 + d^3*x^3)^(1/3)])/(4*c^2*d)}


{1/((1 + 2^(1/3)*x)*(1 + x^3)^(2/3)), x, 1, -(ArcTan[(1 + (2*x)/(1 + x^3)^(1/3))/Sqrt[3]]/(2^(2/3)*Sqrt[3])) + (Sqrt[3]*ArcTan[(1 + (2*(2^(2/3) + x))/(1 + x^3)^(1/3))/Sqrt[3]])/2^(2/3) - Log[1 + 2^(1/3)*x]/2^(2/3) - Log[x - (1 + x^3)^(1/3)]/(2*2^(2/3)) + (3*Log[2 + 2^(1/3)*x - 2^(1/3)*(1 + x^3)^(1/3)])/(2*2^(2/3))}
{1/((1 - 2^(1/3)*x)*(1 - x^3)^(2/3)), x, 1, -((Sqrt[3]*ArcTan[(1 + (2*2^(2/3) - 2*x)/(1 - x^3)^(1/3))/Sqrt[3]])/2^(2/3)) + ArcTan[(1 - (2*x)/(1 - x^3)^(1/3))/Sqrt[3]]/(2^(2/3)*Sqrt[3]) + Log[1 - 2^(1/3)*x]/2^(2/3) + Log[-x - (1 - x^3)^(1/3)]/(2*2^(2/3)) - (3*Log[-2 + 2^(1/3)*x + 2^(1/3)*(1 - x^3)^(1/3)])/(2*2^(2/3))}
...
{(c + d*x)^2/(a + b*x^3)^(1/3), x, 7, (d^2*(a + b*x^3)^(2/3))/(2*b) + (c^2*ArcTan[(1 + (2*b^(1/3)*x)/(a + b*x^3)^(1/3))/Sqrt[3]])/(Sqrt[3]*b^(1/3)) + (c*d*x^2*(1 + (b*x^3)/a)^(1/3)*Hypergeometric2F1[1/3, 2/3, 5/3, -((b*x^3)/a)])/(a + b*x^3)^(1/3) - (c^2*Log[(-b^(1/3))*x + (a + b*x^3)^(1/3)])/(2*b^(1/3))}
{(c + d*x)^1/(a + b*x^3)^(1/3), x, 5, (c*ArcTan[(1 + (2*b^(1/3)*x)/(a + b*x^3)^(1/3))/Sqrt[3]])/(Sqrt[3]*b^(1/3)) + (d*x^2*(1 + (b*x^3)/a)^(1/3)*Hypergeometric2F1[1/3, 2/3, 5/3, -((b*x^3)/a)])/(2*(a + b*x^3)^(1/3)) - (c*Log[(-b^(1/3))*x + (a + b*x^3)^(1/3)])/(2*b^(1/3))}
{1/((c + d*x)^1*(a + b*x^3)^(1/3)), x, 10, -((d*x^2*(1 + (b*x^3)/a)^(1/3)*AppellF1[2/3, 1/3, 1, 5/3, -((b*x^3)/a), -((d^3*x^3)/c^3)])/(2*c^2*(a + b*x^3)^(1/3))) + ArcTan[(1 + (2*(b*c^3 - a*d^3)^(1/3)*x)/(c*(a + b*x^3)^(1/3)))/Sqrt[3]]/(Sqrt[3]*(b*c^3 - a*d^3)^(1/3)) - ArcTan[(1 - (2*d*(a + b*x^3)^(1/3))/(b*c^3 - a*d^3)^(1/3))/Sqrt[3]]/(Sqrt[3]*(b*c^3 - a*d^3)^(1/3)) + Log[c^3 + d^3*x^3]/(3*(b*c^3 - a*d^3)^(1/3)) - Log[((b*c^3 - a*d^3)^(1/3)*x)/c - (a + b*x^3)^(1/3)]/(2*(b*c^3 - a*d^3)^(1/3)) - Log[(b*c^3 - a*d^3)^(1/3) + d*(a + b*x^3)^(1/3)]/(2*(b*c^3 - a*d^3)^(1/3))}
...
{x^5*(c*(a + b*x^2)^2)^(3/2), x, 4, (a^3*c*x^6*Sqrt[c*(a + b*x^2)^2])/(6*(a + b*x^2)) + (3*a^2*b*c*x^8*Sqrt[c*(a + b*x^2)^2])/(8*(a + b*x^2)) + (3*a*b^2*c*x^10*Sqrt[c*(a + b*x^2)^2])/(10*(a + b*x^2)) + (b^3*c*x^12*Sqrt[c*(a + b*x^2)^2])/(12*(a + b*x^2))}
{x^4*(c*(a + b*x^2)^2)^(3/2), x, 3, (a^3*c*x^5*Sqrt[c*(a + b*x^2)^2])/(5*(a + b*x^2)) + (3*a^2*b*c*x^7*Sqrt[c*(a + b*x^2)^2])/(7*(a + b*x^2)) + (a*b^2*c*x^9*Sqrt[c*(a + b*x^2)^2])/(3*(a + b*x^2)) + (b^3*c*x^11*Sqrt[c*(a + b*x^2)^2])/(11*(a + b*x^2))}
{x^3*(c*(a + b*x^2)^2)^(3/2), x, 4, -((a*c*(a + b*x^2)^3*Sqrt[c*(a + b*x^2)^2])/(8*b^2)) + (c*(a + b*x^2)^4*Sqrt[c*(a + b*x^2)^2])/(10*b^2)}
{x^2*(c*(a + b*x^2)^2)^(3/2), x, 3, (a^3*c*x^3*Sqrt[c*(a + b*x^2)^2])/(3*(a + b*x^2)) + (3*a^2*b*c*x^5*Sqrt[c*(a + b*x^2)^2])/(5*(a + b*x^2)) + (3*a*b^2*c*x^7*Sqrt[c*(a + b*x^2)^2])/(7*(a + b*x^2)) + (b^3*c*x^9*Sqrt[c*(a + b*x^2)^2])/(9*(a + b*x^2))}
{x^1*(c*(a + b*x^2)^2)^(3/2), x, 3, (c*(a + b*x^2)^3*Sqrt[c*(a + b*x^2)^2])/(8*b)}
{x^0*(c*(a + b*x^2)^2)^(3/2), x, 3, (a^3*c*x*Sqrt[c*(a + b*x^2)^2])/(a + b*x^2) + (a^2*b*c*x^3*Sqrt[c*(a + b*x^2)^2])/(a + b*x^2) + (3*a*b^2*c*x^5*Sqrt[c*(a + b*x^2)^2])/(5*(a + b*x^2)) + (b^3*c*x^7*Sqrt[c*(a + b*x^2)^2])/(7*(a + b*x^2))}
{(c*(a + b*x^2)^2)^(3/2)/x^1, x, 4, (3*a^2*b*c*x^2*Sqrt[c*(a + b*x^2)^2])/(2*(a + b*x^2)) + (3*a*b^2*c*x^4*Sqrt[c*(a + b*x^2)^2])/(4*(a + b*x^2)) + (b^3*c*x^6*Sqrt[c*(a + b*x^2)^2])/(6*(a + b*x^2)) + (a^3*c*Sqrt[c*(a + b*x^2)^2]*Log[x])/(a + b*x^2)}
{(c*(a + b*x^2)^2)^(3/2)/x^2, x, 3, -((a^3*c*Sqrt[c*(a + b*x^2)^2])/(x*(a + b*x^2))) + (3*a^2*b*c*x*Sqrt[c*(a + b*x^2)^2])/(a + b*x^2) + (a*b^2*c*x^3*Sqrt[c*(a + b*x^2)^2])/(a + b*x^2) + (b^3*c*x^5*Sqrt[c*(a + b*x^2)^2])/(5*(a + b*x^2))}
{(c*(a + b*x^2)^2)^(3/2)/x^3, x, 4, -((a^3*c*Sqrt[c*(a + b*x^2)^2])/(2*x^2*(a + b*x^2))) + (3*a*b^2*c*x^2*Sqrt[c*(a + b*x^2)^2])/(2*(a + b*x^2)) + (b^3*c*x^4*Sqrt[c*(a + b*x^2)^2])/(4*(a + b*x^2)) + (3*a^2*b*c*Sqrt[c*(a + b*x^2)^2]*Log[x])/(a + b*x^2)}


{x^2*(c*(a + b*x^2)^3)^(3/2), x, 8, (7/128)*a^3*c*x^3*Sqrt[c*(a + b*x^2)^3] + (21*a^5*c*x*Sqrt[c*(a + b*x^2)^3])/(1024*b*(a + b*x^2)) + (21*a^4*c*x^3*Sqrt[c*(a + b*x^2)^3])/(512*(a + b*x^2)) + (21/320)*a^2*c*x^3*(a + b*x^2)*Sqrt[c*(a + b*x^2)^3] + (3/40)*a*c*x^3*(a + b*x^2)^2*Sqrt[c*(a + b*x^2)^3] + (1/12)*c*x^3*(a + b*x^2)^3*Sqrt[c*(a + b*x^2)^3] - (21*a^(9/2)*c*Sqrt[c*(a + b*x^2)^3]*ArcSinh[(Sqrt[b]*x)/Sqrt[a]])/(1024*b^(3/2)*(1 + (b*x^2)/a)^(3/2))}
{x^1*(c*(a + b*x^2)^3)^(3/2), x, 3, (c*(a + b*x^2)^4*Sqrt[c*(a + b*x^2)^3])/(11*b)}
{x^0*(c*(a + b*x^2)^3)^(3/2), x, 7, (21/128)*a^3*c*x*Sqrt[c*(a + b*x^2)^3] + (63*a^4*c*x*Sqrt[c*(a + b*x^2)^3])/(256*(a + b*x^2)) + (21/160)*a^2*c*x*(a + b*x^2)*Sqrt[c*(a + b*x^2)^3] + (9/80)*a*c*x*(a + b*x^2)^2*Sqrt[c*(a + b*x^2)^3] + (1/10)*c*x*(a + b*x^2)^3*Sqrt[c*(a + b*x^2)^3] + (63*a^(7/2)*c*Sqrt[c*(a + b*x^2)^3]*ArcSinh[(Sqrt[b]*x)/Sqrt[a]])/(256*Sqrt[b]*(1 + (b*x^2)/a)^(3/2))}
{(c*(a + b*x^2)^3)^(3/2)/x^1, x, 9, (1/3)*a^3*c*Sqrt[c*(a + b*x^2)^3] + (a^4*c*Sqrt[c*(a + b*x^2)^3])/(a + b*x^2) + (1/5)*a^2*c*(a + b*x^2)*Sqrt[c*(a + b*x^2)^3] + (1/7)*a*c*(a + b*x^2)^2*Sqrt[c*(a + b*x^2)^3] + (1/9)*c*(a + b*x^2)^3*Sqrt[c*(a + b*x^2)^3] - (a^3*c*Sqrt[c*(a + b*x^2)^3]*ArcTanh[Sqrt[1 + (b*x^2)/a]])/(1 + (b*x^2)/a)^(3/2)}
{(c*(a + b*x^2)^3)^(3/2)/x^2, x, 7, (105/64)*a^2*b*c*x*Sqrt[c*(a + b*x^2)^3] + (315*a^3*b*c*x*Sqrt[c*(a + b*x^2)^3])/(128*(a + b*x^2)) + (21/16)*a*b*c*x*(a + b*x^2)*Sqrt[c*(a + b*x^2)^3] + (9/8)*b*c*x*(a + b*x^2)^2*Sqrt[c*(a + b*x^2)^3] - (c*(a + b*x^2)^3*Sqrt[c*(a + b*x^2)^3])/x + (315*a^(5/2)*Sqrt[b]*c*Sqrt[c*(a + b*x^2)^3]*ArcSinh[(Sqrt[b]*x)/Sqrt[a]])/(128*(1 + (b*x^2)/a)^(3/2))}
{(c*(a + b*x^2)^3)^(3/2)/x^3, x, 9, (3/2)*a^2*b*c*Sqrt[c*(a + b*x^2)^3] + (9*a^3*b*c*Sqrt[c*(a + b*x^2)^3])/(2*(a + b*x^2)) + (9/10)*a*b*c*(a + b*x^2)*Sqrt[c*(a + b*x^2)^3] + (9/14)*b*c*(a + b*x^2)^2*Sqrt[c*(a + b*x^2)^3] - (c*(a + b*x^2)^3*Sqrt[c*(a + b*x^2)^3])/(2*x^2) - (9*a^2*b*c*Sqrt[c*(a + b*x^2)^3]*ArcTanh[Sqrt[1 + (b*x^2)/a]])/(2*(1 + (b*x^2)/a)^(3/2))}
...
{x^2*(c/(a + b*x^2))^(3/2), x, 3, -((c*x*Sqrt[c/(a + b*x^2)])/b) + (Sqrt[a]*c*Sqrt[c/(a + b*x^2)]*Sqrt[1 + (b*x^2)/a]*ArcSinh[(Sqrt[b]*x)/Sqrt[a]])/b^(3/2)}
{x^1*(c/(a + b*x^2))^(3/2), x, 3, -((c*Sqrt[c/(a + b*x^2)])/b)}
{x^0*(c/(a + b*x^2))^(3/2), x, 2, (c*x*Sqrt[c/(a + b*x^2)])/a}
{(c/(a + b*x^2))^(3/2)/x^1, x, 5, (c*Sqrt[c/(a + b*x^2)])/a - (c*Sqrt[c/(a + b*x^2)]*Sqrt[1 + (b*x^2)/a]*ArcTanh[Sqrt[1 + (b*x^2)/a]])/a}
{(c/(a + b*x^2))^(3/2)/x^2, x, 3, -((c*Sqrt[c/(a + b*x^2)])/(a*x)) - (2*b*c*x*Sqrt[c/(a + b*x^2)])/a^2}
{(c/(a + b*x^2))^(3/2)/x^3, x, 6, -((3*b*c*Sqrt[c/(a + b*x^2)])/(2*a^2)) - (c*Sqrt[c/(a + b*x^2)])/(2*a*x^2) + (3*b*c*Sqrt[c/(a + b*x^2)]*Sqrt[1 + (b*x^2)/a]*ArcTanh[Sqrt[1 + (b*x^2)/a]])/(2*a^2)}
...
{x^7*(c*(a + b*x^2)^(1/2))^(3/2), x, 4, -((2*a^3*(c*Sqrt[a + b*x^2])^(3/2)*(a + b*x^2))/(7*b^4)) + (6*a^2*(c*Sqrt[a + b*x^2])^(3/2)*(a + b*x^2)^2)/(11*b^4) - (2*a*(c*Sqrt[a + b*x^2])^(3/2)*(a + b*x^2)^3)/(5*b^4) + (2*(c*Sqrt[a + b*x^2])^(3/2)*(a + b*x^2)^4)/(19*b^4)}
{x^5*(c*(a + b*x^2)^(1/2))^(3/2), x, 4, (2*a^2*(c*Sqrt[a + b*x^2])^(3/2)*(a + b*x^2))/(7*b^3) - (4*a*(c*Sqrt[a + b*x^2])^(3/2)*(a + b*x^2)^2)/(11*b^3) + (2*(c*Sqrt[a + b*x^2])^(3/2)*(a + b*x^2)^3)/(15*b^3)}
{x^3*(c*(a + b*x^2)^(1/2))^(3/2), x, 4, -((2*a*(c*Sqrt[a + b*x^2])^(3/2)*(a + b*x^2))/(7*b^2)) + (2*(c*Sqrt[a + b*x^2])^(3/2)*(a + b*x^2)^2)/(11*b^2)}
{x^1*(c*(a + b*x^2)^(1/2))^(3/2), x, 3, (2*c*Sqrt[c*Sqrt[a + b*x^2]]*(a + b*x^2)^(3/2))/(7*b)}
{(c*(a + b*x^2)^(1/2))^(3/2)/x^1, x, 7, (2/3)*(c*Sqrt[a + b*x^2])^(3/2) + ((c*Sqrt[a + b*x^2])^(3/2)*ArcTan[(1 + (b*x^2)/a)^(1/4)])/(1 + (b*x^2)/a)^(3/4) - ((c*Sqrt[a + b*x^2])^(3/2)*ArcTanh[(1 + (b*x^2)/a)^(1/4)])/(1 + (b*x^2)/a)^(3/4)}
{(c*(a + b*x^2)^(1/2))^(3/2)/x^3, x, 7, -((c*Sqrt[a + b*x^2])^(3/2)/(2*x^2)) + (3*b*(c*Sqrt[a + b*x^2])^(3/2)*ArcTan[(1 + (b*x^2)/a)^(1/4)])/(4*a*(1 + (b*x^2)/a)^(3/4)) - (3*b*(c*Sqrt[a + b*x^2])^(3/2)*ArcTanh[(1 + (b*x^2)/a)^(1/4)])/(4*a*(1 + (b*x^2)/a)^(3/4))}

{x^2*(c*(a + b*x^2)^(1/2))^(3/2), x, 5, (2*a*x*(c*Sqrt[a + b*x^2])^(3/2))/(15*b) + (2/9)*x^3*(c*Sqrt[a + b*x^2])^(3/2) - (4*a^2*x*(c*Sqrt[a + b*x^2])^(3/2))/(15*b*(a + b*x^2)) + (4*a^(3/2)*(c*Sqrt[a + b*x^2])^(3/2)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(15*b^(3/2)*(1 + (b*x^2)/a)^(3/4))}
{x^0*(c*(a + b*x^2)^(1/2))^(3/2), x, 4, (2/5)*x*(c*Sqrt[a + b*x^2])^(3/2) + (6*a*x*(c*Sqrt[a + b*x^2])^(3/2))/(5*(a + b*x^2)) - (6*Sqrt[a]*(c*Sqrt[a + b*x^2])^(3/2)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(5*Sqrt[b]*(1 + (b*x^2)/a)^(3/4))}
{(c*(a + b*x^2)^(1/2))^(3/2)/x^2, x, 4, -((c*Sqrt[a + b*x^2])^(3/2)/x) + (3*b*x*(c*Sqrt[a + b*x^2])^(3/2))/(a + b*x^2) - (3*Sqrt[b]*(c*Sqrt[a + b*x^2])^(3/2)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(Sqrt[a]*(1 + (b*x^2)/a)^(3/4))}
{(c*(a + b*x^2)^(1/2))^(3/2)/x^4, x, 5, -((c*Sqrt[a + b*x^2])^(3/2)/(3*x^3)) - (b*(c*Sqrt[a + b*x^2])^(3/2))/(2*a*x) + (b^2*x*(c*Sqrt[a + b*x^2])^(3/2))/(2*a*(a + b*x^2)) - (b^(3/2)*(c*Sqrt[a + b*x^2])^(3/2)*EllipticE[(1/2)*ArcTan[(Sqrt[b]*x)/Sqrt[a]], 2])/(2*a^(3/2)*(1 + (b*x^2)/a)^(3/4))}
...
{x^3*Sqrt[(e*(a + b*x^2))/(c + d*x^2)], x, 5, -((5*b*c - a*d)*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2))/(8*b*d^2) + (Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2)^2)/(4*d^2) + ((b*c - a*d)*(3*b*c + a*d)*Sqrt[e]*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(8*b^(3/2)*d^(5/2))}
{x^1*Sqrt[(e*(a + b*x^2))/(c + d*x^2)], x, 4, (Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2))/(2*d) - ((b*c - a*d)*Sqrt[e]*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(2*Sqrt[b]*d^(3/2))}
{Sqrt[(e*(a + b*x^2))/(c + d*x^2)]/x^1, x, 5, -((Sqrt[a]*Sqrt[e]*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/Sqrt[c]) + (Sqrt[b]*Sqrt[e]*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/Sqrt[d]}
{Sqrt[(e*(a + b*x^2))/(c + d*x^2)]/x^3, x, 4, ((b*c - a*d)*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(2*c*(a - (c*(a + b*x^2))/(c + d*x^2))) - ((b*c - a*d)*Sqrt[e]*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/(2*Sqrt[a]*c^(3/2))}
{Sqrt[(e*(a + b*x^2))/(c + d*x^2)]/x^5, x, 5, -((b*c - a*d)^2*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(4*c^2*(a - (c*(a + b*x^2))/(c + d*x^2))^2) + ((b*c - 5*a*d)*(b*c - a*d)*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(8*a*c^2*(a - (c*(a + b*x^2))/(c + d*x^2))) + ((b*c - a*d)*(b*c + 3*a*d)*Sqrt[e]*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/(8*a^(3/2)*c^(5/2))}
...
{x^0*Sqrt[(e*(a + b*x^2))/(c + d*x^2)], x, 5, x*Sqrt[(e*(a + b*x^2))/(c + d*x^2)] - (Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))]) + (Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], 1 - (b*c)/(a*d)])/(Sqrt[d]*Sqrt[(c*(a + b*x^2))/(a*(c + d*x^2))])}
...
{x^3*((e*(a + b*x^2))/(c + d*x^2))^(3/2), x, 6, -((c*(b*c - a*d)*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/d^3) - ((9*b*c - 5*a*d)*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2))/(8*d^3) + (b*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2)^2)/(4*d^3) + (3*(b*c - a*d)*(5*b*c - a*d)*e^(3/2)*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(8*Sqrt[b]*d^(7/2))}
{x^1*((e*(a + b*x^2))/(c + d*x^2))^(3/2), x, 5, (3*(b*c - a*d)*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(2*d^2) + (((e*(a + b*x^2))/(c + d*x^2))^(3/2)*(c + d*x^2))/(2*d) - (3*Sqrt[b]*(b*c - a*d)*e^(3/2)*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(2*d^(5/2))}
{((e*(a + b*x^2))/(c + d*x^2))^(3/2)/x^1, x, 6, -(((b*c - a*d)*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(c*d)) - (a^(3/2)*e^(3/2)*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/c^(3/2) + (b^(3/2)*e^(3/2)*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/d^(3/2)}
{((e*(a + b*x^2))/(c + d*x^2))^(3/2)/x^3, x, 5, (3*(b*c - a*d)*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(2*c^2) + ((b*c - a*d)*((e*(a + b*x^2))/(c + d*x^2))^(3/2))/(2*c*(a - (c*(a + b*x^2))/(c + d*x^2))) - (3*Sqrt[a]*(b*c - a*d)*e^(3/2)*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/(2*c^(5/2))}
...
{x^8*Sqrt[(1 - x^3)/(1 + x^3)], x, 6, (1/2)*Sqrt[(1 - x^3)/(1 + x^3)]*(1 + x^3) - (1/6)*Sqrt[(1 - x^3)/(1 + x^3)]*(1 + x^3)^2 - (1/9)*((1 - x^3)/(1 + x^3))^(3/2)*(1 + x^3)^3 - (1/3)*ArcTan[Sqrt[(1 - x^3)/(1 + x^3)]]}
{x^9*Sqrt[(5 - 7*x^5)/(7 + 5*x^5)], x, 5, (-(27/350))*Sqrt[(5 - 7*x^5)/(7 + 5*x^5)]*(7 + 5*x^5) + (1/250)*Sqrt[(5 - 7*x^5)/(7 + 5*x^5)]*(7 + 5*x^5)^2 + (2257*ArcTan[Sqrt[5/7]*Sqrt[(5 - 7*x^5)/(7 + 5*x^5)]])/(875*Sqrt[35])}


{Sqrt[x^2/(-1 + x^2)]/(1 + x^2), x, 5, (Sqrt[-(x^2/(1 - x^2))]*Sqrt[-1 + x^2]*ArcTan[Sqrt[-1 + x^2]/Sqrt[2]])/(Sqrt[2]*x)}
{Sqrt[x^2/(-1 + a + (1 + a)*x^2)]/(1 + x^2), x, 5, (Sqrt[-(x^2/(1 - a - (1 + a)*x^2))]*Sqrt[-1 + a + (1 + a)*x^2]*ArcTan[Sqrt[-1 + a + (1 + a)*x^2]/Sqrt[2]])/(Sqrt[2]*x)}
...
{x^3/Sqrt[(e*(a + b*x^2))/(c + d*x^2)], x, 5, -((b*c + 3*a*d)*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2))/(8*b^2*d*e) + (Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2)^2)/(4*b*d*e) - ((b*c - a*d)*(b*c + 3*a*d)*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(8*b^(5/2)*d^(3/2)*Sqrt[e])}
{x^1/Sqrt[(e*(a + b*x^2))/(c + d*x^2)], x, 4, (Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2))/(2*b*e) + ((b*c - a*d)*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(2*b^(3/2)*Sqrt[d]*Sqrt[e])}
{1/(x^1*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]), x, 5, -((Sqrt[c]*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/(Sqrt[a]*Sqrt[e])) + (Sqrt[d]*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(Sqrt[b]*Sqrt[e])}
{1/(x^3*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]), x, 4, ((b*c - a*d)*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(2*a*(a*e - (c*e*(a + b*x^2))/(c + d*x^2))) + ((b*c - a*d)*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/(2*a^(3/2)*Sqrt[c]*Sqrt[e])}
{1/(x^5*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]), x, 5, -((b*c - a*d)^2*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(4*a*c*(a*e - (c*e*(a + b*x^2))/(c + d*x^2))^2) - ((b*c - a*d)*(3*b*c + a*d)*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(8*a^2*c*(a*e - (c*e*(a + b*x^2))/(c + d*x^2))) - ((b*c - a*d)*(3*b*c + a*d)*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/(8*a^(5/2)*c^(3/2)*Sqrt[e])}
...
{x^5/((e*(a + b*x^2))/(c + d*x^2))^(3/2), x, 7, -((b^2*c^2 + 5*a*d*(2*b*c - 7*a*d))*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2))/(16*b^4*d*e^2) - ((b^2*c^2 + 5*a*d*(2*b*c - 7*a*d))*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2)^2)/(24*b^3*d*(b*c - a*d)*e^2) - (a^2*(c + d*x^2)^3)/(b*(b*c - a*d)^2*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]) + ((b^2*c^2 - 2*a*b*c*d + 7*a^2*d^2)*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2)^3)/(6*b^2*d*(b*c - a*d)^2*e^2) - ((b*c - a*d)*(b^2*c^2 + 5*a*d*(2*b*c - 7*a*d))*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(16*b^(9/2)*d^(3/2)*e^(3/2))}
{x^3/((e*(a + b*x^2))/(c + d*x^2))^(3/2), x, 6, (a*(b*c - a*d))/(b^3*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]) + ((3*b*c - 7*a*d)*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2))/(8*b^3*e^2) + (Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(c + d*x^2)^2)/(4*b^2*e^2) + (3*(b*c - 5*a*d)*(b*c - a*d)*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(8*b^(7/2)*Sqrt[d]*e^(3/2))}
{x^1/((e*(a + b*x^2))/(c + d*x^2))^(3/2), x, 5, (-3*(b*c - a*d))/(2*b^2*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]) + (c + d*x^2)/(2*b*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]) + (3*Sqrt[d]*(b*c - a*d)*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(2*b^(5/2)*e^(3/2))}
{1/(x^1*((e*(a + b*x^2))/(c + d*x^2))^(3/2)), x, 6, (b*c - a*d)/(a*b*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]) - (c^(3/2)*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/(a^(3/2)*e^(3/2)) + (d^(3/2)*ArcTanh[(Sqrt[d]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[b]*Sqrt[e])])/(b^(3/2)*e^(3/2))}
{1/(x^3*((e*(a + b*x^2))/(c + d*x^2))^(3/2)), x, 5, (-3*(b*c - a*d))/(2*a^2*e*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]) + (b*c - a*d)/(2*a*Sqrt[(e*(a + b*x^2))/(c + d*x^2)]*(a*e - (c*e*(a + b*x^2))/(c + d*x^2))) + (3*Sqrt[c]*(b*c - a*d)*ArcTanh[(Sqrt[c]*Sqrt[(e*(a + b*x^2))/(c + d*x^2)])/(Sqrt[a]*Sqrt[e])])/(2*a^(5/2)*e^(3/2))}
...
{x^5*Sqrt[a + b/(c + d*x^2)], x, 7, -((b^2 + 4*a*b*c - 8*a^2*c^2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(16*a^2*d^3) - ((b + 4*a*c)*(c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*a*d^3) + ((c + d*x^2)^3*((b + a*c + a*d*x^2)/(c + d*x^2))^(3/2))/(6*a*d^3) + (b*(b^2 + 4*a*b*c + 8*a^2*c^2)*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]])/(16*a^(5/2)*d^3)}
{x^3*Sqrt[a + b/(c + d*x^2)], x, 6, ((b - 4*a*c)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*a*d^2) + ((c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(4*d^2) - (b*(b + 4*a*c)*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]])/(8*a^(3/2)*d^2)}
{x^1*Sqrt[a + b/(c + d*x^2)], x, 5, ((c + d*x^2)*Sqrt[a + b/(c + d*x^2)])/(2*d) + (b*ArcTanh[Sqrt[a + b/(c + d*x^2)]/Sqrt[a]])/(2*Sqrt[a]*d)}
{Sqrt[a + b/(c + d*x^2)]/x^1, x, 6, Sqrt[a]*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]] - (Sqrt[b + a*c]*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/Sqrt[c]}
{Sqrt[a + b/(c + d*x^2)]/x^3, x, 5, -((c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(2*c*x^2) + (b*d*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(2*c^(3/2)*Sqrt[b + a*c])}
{Sqrt[a + b/(c + d*x^2)]/x^5, x, 6, ((5*b + 4*a*c)*d*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*c^2*(b + a*c)*x^2) - ((c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(4*c^2*x^4) - (b*(3*b + 4*a*c)*d^2*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(8*c^(5/2)*(b + a*c)^(3/2))}
{Sqrt[a + b/(c + d*x^2)]/x^7, x, 7, -((11*b^2 + 20*a*b*c + 8*a^2*c^2)*d^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(16*c^3*(b + a*c)^2*x^2) + ((3*b + 4*a*c)*d*(c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*c^3*(b + a*c)*x^4) - ((c + d*x^2)^3*((b + a*c + a*d*x^2)/(c + d*x^2))^(3/2))/(6*c^2*(b + a*c)*x^6) + (b*(5*b^2 + 12*a*b*c + 8*a^2*c^2)*d^3*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(16*c^(7/2)*(b + a*c)^(5/2))}
...
{x^0*Sqrt[a + b/(c + d*x^2)], x, 6, x*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)] - (Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(Sqrt[d]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) + (Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(Sqrt[d]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
...
{x^5*(a + b/(c + d*x^2))^(3/2), x, 8, -((b*c^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/d^3) - ((5*b^2 + 60*a*b*c - 24*a^2*c^2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(48*a*d^3) - ((b + 12*a*c)*(c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(24*d^3) + ((c + d*x^2)^3*((b + a*c + a*d*x^2)/(c + d*x^2))^(5/2))/(6*a*d^3) - (b*(b^2 + 12*a*b*c - 24*a^2*c^2)*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]])/(16*a^(3/2)*d^3)}
{x^3*(a + b/(c + d*x^2))^(3/2), x, 7, (b*c*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/d^2 + ((5*b - 4*a*c)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*d^2) + (a*(c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(4*d^2) + (3*b*(b - 4*a*c)*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]])/(8*Sqrt[a]*d^2)}
{x^1*(a + b/(c + d*x^2))^(3/2), x, 6, (-3*b*Sqrt[a + b/(c + d*x^2)])/(2*d) + ((c + d*x^2)*(a + b/(c + d*x^2))^(3/2))/(2*d) + (3*Sqrt[a]*b*ArcTanh[Sqrt[a + b/(c + d*x^2)]/Sqrt[a]])/(2*d)}
{(a + b/(c + d*x^2))^(3/2)/x^1, x, 7, (b*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/c + a^(3/2)*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]] - ((b + a*c)^(3/2)*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/c^(3/2)}
{(a + b/(c + d*x^2))^(3/2)/x^3, x, 6, (-3*b*d*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(2*c^2) - ((c + d*x^2)*((b + a*c + a*d*x^2)/(c + d*x^2))^(3/2))/(2*c*x^2) + (3*b*Sqrt[b + a*c]*d*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(2*c^(5/2))}
{(a + b/(c + d*x^2))^(3/2)/x^5, x, 7, (b*d^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/c^3 + ((9*b + 4*a*c)*d*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*c^3*x^2) - ((b + a*c)*(c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(4*c^3*x^4) - (3*b*(5*b + 4*a*c)*d^2*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(8*c^(7/2)*Sqrt[b + a*c])}
{(a + b/(c + d*x^2))^(3/2)/x^7, x, 8, -((b*d^3*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/c^4) - ((79*b^2 + 108*a*b*c + 24*a^2*c^2)*d^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(48*c^4*(b + a*c)*x^2) + ((11*b + 12*a*c)*d*(c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(24*c^4*x^4) - ((c + d*x^2)^3*((b + a*c + a*d*x^2)/(c + d*x^2))^(5/2))/(6*c^2*(b + a*c)*x^6) + (b*(35*b^2 + 60*a*b*c + 24*a^2*c^2)*d^3*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(16*c^(9/2)*(b + a*c)^(3/2))}
...
{x^5/Sqrt[a + b/(c + d*x^2)], x, 7, ((5*b^2 + 12*a*b*c + 8*a^2*c^2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(16*a^3*d^3) - ((5*b + 8*a*c)*(c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(24*a^2*d^3) + (x^2*(c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(6*a*d^2) - (b*(5*b^2 + 12*a*b*c + 8*a^2*c^2)*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]])/(16*a^(7/2)*d^3)}
{x^3/Sqrt[a + b/(c + d*x^2)], x, 6, -((3*b + 4*a*c)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*a^2*d^2) + ((c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(4*a*d^2) + (b*(3*b + 4*a*c)*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]])/(8*a^(5/2)*d^2)}
{x^1/Sqrt[a + b/(c + d*x^2)], x, 5, ((c + d*x^2)*Sqrt[a + b/(c + d*x^2)])/(2*a*d) - (b*ArcTanh[Sqrt[a + b/(c + d*x^2)]/Sqrt[a]])/(2*a^(3/2)*d)}
{1/(x^1*Sqrt[a + b/(c + d*x^2)]), x, 6, ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]]/Sqrt[a] - (Sqrt[c]*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/Sqrt[b + a*c]}
{1/(x^3*Sqrt[a + b/(c + d*x^2)]), x, 5, -((c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(2*(b + a*c)*x^2) - (b*d*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(2*Sqrt[c]*(b + a*c)^(3/2))}
{1/(x^5*Sqrt[a + b/(c + d*x^2)]), x, 6, ((b + 4*a*c)*d*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*c*(b + a*c)^2*x^2) - ((c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(4*c*(b + a*c)*x^4) + (b*(b + 4*a*c)*d^2*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(8*c^(3/2)*(b + a*c)^(5/2))}

{x^4/Sqrt[a + b/(c + d*x^2)], x, 8, -((4*b + 3*a*c)*x*(b + a*c + a*d*x^2))/(15*a^2*d^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) + (x^3*(b + a*c + a*d*x^2))/(5*a*d*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) + ((8*b^2 + 13*a*b*c + 3*a^2*c^2)*x*(b + a*c + a*d*x^2))/(15*a^3*d^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - (Sqrt[c]*(8*b^2 + 13*a*b*c + 3*a^2*c^2)*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(15*a^3*d^(5/2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) + (c^(3/2)*(4*b + 3*a*c)*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(15*a^2*d^(5/2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
{x^2/Sqrt[a + b/(c + d*x^2)], x, 7, (x*(b + a*c + a*d*x^2))/(3*a*d*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - ((2*b + a*c)*x*(b + a*c + a*d*x^2))/(3*a^2*d*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) + (Sqrt[c]*(2*b + a*c)*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(3*a^2*d^(3/2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) - (c^(3/2)*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(3*a*d^(3/2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
{x^0/Sqrt[a + b/(c + d*x^2)], x, 6, (x*(b + a*c + a*d*x^2))/(a*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - (Sqrt[c]*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(a*Sqrt[d]*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) + (c^(3/2)*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/((b + a*c)*Sqrt[d]*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
{1/(x^2*Sqrt[a + b/(c + d*x^2)]), x, 8, -((b + a*c + a*d*x^2)/((b + a*c)*x*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) + (d*x*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - (Sqrt[c]*Sqrt[d]*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/((b + a*c)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) + (Sqrt[c]*Sqrt[d]*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/((b + a*c)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
{1/(x^4*Sqrt[a + b/(c + d*x^2)]), x, 8, -(b + a*c + a*d*x^2)/(3*(b + a*c)*x^3*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - ((b - a*c)*d*(b + a*c + a*d*x^2))/(3*c*(b + a*c)^2*x*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) + ((b - a*c)*d^2*x*(b + a*c + a*d*x^2))/(3*c*(b + a*c)^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - ((b - a*c)*d^(3/2)*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(3*Sqrt[c]*(b + a*c)^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) - (a*Sqrt[c]*d^(3/2)*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(3*(b + a*c)^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}


{x^5/(a + b/(c + d*x^2))^(3/2), x, 8, -(((b + a*c)^2*(c + d*x^2)^3)/(a*b^2*d^3*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) + ((35*b^2 + 60*a*b*c + 24*a^2*c^2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(16*a^4*d^3) - ((35*b^2 + 60*a*b*c + 24*a^2*c^2)*(c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(24*a^3*b*d^3) + ((7*b^2 + 12*a*b*c + 6*a^2*c^2)*(c + d*x^2)^3*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(6*a^2*b^2*d^3) - (b*(35*b^2 + 60*a*b*c + 24*a^2*c^2)*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]])/(16*a^(9/2)*d^3)}
{x^3/(a + b/(c + d*x^2))^(3/2), x, 7, -((b*(b + a*c))/(a^3*d^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) - ((7*b + 4*a*c)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*a^3*d^2) + ((c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(4*a^2*d^2) + (3*b*(5*b + 4*a*c)*ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]])/(8*a^(7/2)*d^2)}
{x^1/(a + b/(c + d*x^2))^(3/2), x, 6, (3*b)/(2*a^2*d*Sqrt[a + b/(c + d*x^2)]) + (c + d*x^2)/(2*a*d*Sqrt[a + b/(c + d*x^2)]) - (3*b*ArcTanh[Sqrt[a + b/(c + d*x^2)]/Sqrt[a]])/(2*a^(5/2)*d)}
{1/(x^1*(a + b/(c + d*x^2))^(3/2)), x, 7, -(b/(a*(b + a*c)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) + ArcTanh[Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]/Sqrt[a]]/a^(3/2) - (c^(3/2)*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(b + a*c)^(3/2)}
{1/(x^3*(a + b/(c + d*x^2))^(3/2)), x, 6, (3*b*d)/(2*(b + a*c)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - (c + d*x^2)/(2*(b + a*c)*x^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - (3*b*Sqrt[c]*d*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(2*(b + a*c)^(5/2))}
{1/(x^5*(a + b/(c + d*x^2))^(3/2)), x, 7, -((a*b*d^2)/((b + a*c)^3*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) - ((3*b - 4*a*c)*d*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(8*(b + a*c)^3*x^2) - ((c + d*x^2)^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/(4*(b + a*c)^2*x^4) - (3*b*(b - 4*a*c)*d^2*ArcTanh[(Sqrt[c]*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])/Sqrt[b + a*c]])/(8*Sqrt[c]*(b + a*c)^(7/2))}

{x^4/(a + b/(c + d*x^2))^(3/2), x, 9, -((x^3*(c + d*x^2))/(a*d*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) - ((8*b + a*c)*x*(b + a*c + a*d*x^2))/(5*a^3*d^2*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) + (6*x^3*(b + a*c + a*d*x^2))/(5*a^2*d*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) + ((16*b^2 + 16*a*b*c + a^2*c^2)*x*(b + a*c + a*d*x^2))/(5*a^4*d^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - (Sqrt[c]*(16*b^2 + 16*a*b*c + a^2*c^2)*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(5*a^4*d^(5/2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) + (c^(3/2)*(8*b + a*c)*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(5*a^3*d^(5/2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
{x^2/(a + b/(c + d*x^2))^(3/2), x, 8, -((x*(c + d*x^2))/(a*d*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) + (4*x*(b + a*c + a*d*x^2))/(3*a^2*d*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - ((8*b + a*c)*x*(b + a*c + a*d*x^2))/(3*a^3*d*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) + (Sqrt[c]*(8*b + a*c)*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(3*a^3*d^(3/2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) - (c^(3/2)*(4*b + a*c)*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(3*a^2*(b + a*c)*d^(3/2)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
{x^0/(a + b/(c + d*x^2))^(3/2), x, 7, -((b*x)/(a*(b + a*c)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) + ((2*b + a*c)*x*(b + a*c + a*d*x^2))/(a^2*(b + a*c)*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - (Sqrt[c]*(2*b + a*c)*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(a^2*(b + a*c)*Sqrt[d]*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) + (c^(3/2)*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(a*(b + a*c)*Sqrt[d]*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
{1/(x^2*(a + b/(c + d*x^2))^(3/2)), x, 8, -(b/(a*(b + a*c)*x*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) + ((b - a*c)*(b + a*c + a*d*x^2))/(a*(b + a*c)^2*x*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - ((b - a*c)*d*x*(b + a*c + a*d*x^2))/(a*(b + a*c)^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) + (Sqrt[c]*(b - a*c)*Sqrt[d]*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(a*(b + a*c)^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) + (c^(3/2)*Sqrt[d]*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/((b + a*c)^2*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
{1/(x^4*(a + b/(c + d*x^2))^(3/2)), x, 9, -(b/(a*(b + a*c)*x^3*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)])) + ((3*b - a*c)*(b + a*c + a*d*x^2))/(3*a*(b + a*c)^2*x^3*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - ((7*b - a*c)*d*(b + a*c + a*d*x^2))/(3*(b + a*c)^3*x*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) + ((7*b - a*c)*d^2*x*(b + a*c + a*d*x^2))/(3*(b + a*c)^3*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]) - (Sqrt[c]*(7*b - a*c)*d^(3/2)*(b + a*c + a*d*x^2)*EllipticE[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(3*(b + a*c)^3*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))]) + (Sqrt[c]*(3*b - a*c)*d^(3/2)*(b + a*c + a*d*x^2)*EllipticF[ArcTan[(Sqrt[d]*x)/Sqrt[c]], b/(b + a*c)])/(3*(b + a*c)^3*(c + d*x^2)*Sqrt[(b + a*c + a*d*x^2)/(c + d*x^2)]*Sqrt[(c*(b + a*c + a*d*x^2))/((b + a*c)*(c + d*x^2))])}
...
{Sqrt[1/(-1 + x^2)], x, 2, Sqrt[1 - x^2]*Sqrt[1/(-1 + x^2)]*ArcSin[x]}
{Sqrt[(1 + x^2)/(-1 + x^4)], x, 3, Sqrt[1 - x^2]*Sqrt[1/(-1 + x^2)]*ArcSin[x]}
...
{1/(x*(3 + 3*x + x^2)*(3 + 3*x + 3*x^2 + x^3)^(1/3)), x, 3, -(ArcTan[(1 + (2*3^(1/3)*(1 + x))/(2 + (1 + x)^3)^(1/3))/Sqrt[3]]/3^(5/6)) - Log[1 - (1 + x)^3]/(6*3^(1/3)) + Log[3^(1/3)*(1 + x) - (2 + (1 + x)^3)^(1/3)]/(2*3^(1/3))}


{(1 - x^2)/((1 - x + x^2)*(1 - x^3)^(2/3)), x, -42, (Sqrt[3]*ArcTan[(1 - (2*2^(1/3)*(1 - x))/(1 - x^3)^(1/3))/Sqrt[3]])/2^(2/3) - Log[1 + 2*(1 - x)^3 - x^3]/(2*2^(2/3)) + (3*Log[2^(1/3)*(1 - x) + (1 - x^3)^(1/3)])/(2*2^(2/3))}
