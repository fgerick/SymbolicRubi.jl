...
{x^2/(a + b*ArcSin[c*x]), x, 9, (Cos[a/b]*CosIntegral[(a + b*ArcSin[c*x])/b])/(4*b*c^3) - (Cos[(3*a)/b]*CosIntegral[(3*(a + b*ArcSin[c*x]))/b])/(4*b*c^3) + (Sin[a/b]*SinIntegral[(a + b*ArcSin[c*x])/b])/(4*b*c^3) - (Sin[(3*a)/b]*SinIntegral[(3*(a + b*ArcSin[c*x]))/b])/(4*b*c^3)}
{x^1/(a + b*ArcSin[c*x]), x, 6, -((CosIntegral[(2*(a + b*ArcSin[c*x]))/b]*Sin[(2*a)/b])/(2*b*c^2)) + (Cos[(2*a)/b]*SinIntegral[(2*(a + b*ArcSin[c*x]))/b])/(2*b*c^2)}
...
{x^2/(a + b*ArcSin[c*x])^2, x, 8, -((x^2*Sqrt[1 - c^2*x^2])/(b*c*(a + b*ArcSin[c*x]))) + (CosIntegral[(a + b*ArcSin[c*x])/b]*Sin[a/b])/(4*b^2*c^3) - (3*CosIntegral[(3*(a + b*ArcSin[c*x]))/b]*Sin[(3*a)/b])/(4*b^2*c^3) - (Cos[a/b]*SinIntegral[(a + b*ArcSin[c*x])/b])/(4*b^2*c^3) + (3*Cos[(3*a)/b]*SinIntegral[(3*(a + b*ArcSin[c*x]))/b])/(4*b^2*c^3)}
{x^1/(a + b*ArcSin[c*x])^2, x, 4, -((x*Sqrt[1 - c^2*x^2])/(b*c*(a + b*ArcSin[c*x]))) + (Cos[(2*a)/b]*CosIntegral[(2*(a + b*ArcSin[c*x]))/b])/(b^2*c^2) + (Sin[(2*a)/b]*SinIntegral[(2*(a + b*ArcSin[c*x]))/b])/(b^2*c^2)}
{x^0/(a + b*ArcSin[c*x])^2, x, 5, -(Sqrt[1 - c^2*x^2]/(b*c*(a + b*ArcSin[c*x]))) + (CosIntegral[(a + b*ArcSin[c*x])/b]*Sin[a/b])/(b^2*c) - (Cos[a/b]*SinIntegral[(a + b*ArcSin[c*x])/b])/(b^2*c)}
