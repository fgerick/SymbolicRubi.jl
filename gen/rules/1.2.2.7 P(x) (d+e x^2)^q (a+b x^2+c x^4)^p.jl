...
@rule integrate((~A + ~B*((~x)^2))*(((~d + ~e*((~x)^2))^-1)*(Sqrt(~a + ~b*((~x)^2) + ~c*((~x)^4))^-1)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~A, ~B), ~x), NeQ((~b)^2 - 4 * ~a*~c, 0), NeQ(~a*((~e)^2) + ~c*((~d)^2) - ~b*~d*~e, 0), NeQ(~c*((~d)^2) - ~a*((~e)^2), 0), PosQ(~c*((~a)^-1)), EqQ(~c*((~A)^2) - ~a*((~B)^2), 0)) 
 With(List(Set(~q, Rt(~B*((~A)^-1), 2))), (~A*~e - ~B*~d)*((1//2)*((~d)^-1)*((~e)^-1)*(Rt(~a*~e*((~d)^-1) + ~c*~d*((~e)^-1) - ~b, 2)^-1))*ArcTan(~x*(Sqrt(~a + ~b*((~x)^2) + ~c*((~x)^4))^-1)*Rt(~a*~e*((~d)^-1) + ~c*~d*((~e)^-1) - ~b, 2)) + (~A*~e + ~B*~d)*(~A + ~B*((~x)^2))*((1//4)*((~A)^-1)*((~d)^-1)*((~e)^-1)*((~q)^-1)*(Sqrt(~a + ~b*((~x)^2) + ~c*((~x)^4))^-1))*EllipticPi(Cancel(-((~B*~d - ~A*~e)^2)*((1//4)*((~A)^-1)*((~B)^-1)*((~d)^-1)*((~e)^-1))), 2ArcTan(~q*~x), 2^-1 - ~A*~b*((1//4)*((~B)^-1)*((~a)^-1)))*Sqrt((~a + ~b*((~x)^2) + ~c*((~x)^4))*((~A)^2)*(((~a)^-1)*((~A + ~B*((~x)^2))^-2))))
 end
...
@rule integrate((~A + ~B*((~x)^2))*(((~d + ~e*((~x)^2))^-1)*(Sqrt(~a + ~c*((~x)^4))^-1)), ~x) =>  if And(FreeQ(List(~a, ~c, ~d, ~e, ~A, ~B), ~x), NeQ(~a*((~e)^2) + ~c*((~d)^2), 0), NeQ(~c*((~d)^2) - ~a*((~e)^2), 0), PosQ(~c*((~a)^-1)), EqQ(~c*((~A)^2) - ~a*((~B)^2), 0)) 
 With(List(Set(~q, Rt(~B*((~A)^-1), 2))), (~A*~e - ~B*~d)*((1//2)*((~d)^-1)*((~e)^-1)*(Rt(~a*~e*((~d)^-1) + ~c*~d*((~e)^-1), 2)^-1))*ArcTan(~x*(Sqrt(~a + ~c*((~x)^4))^-1)*Rt(~a*~e*((~d)^-1) + ~c*~d*((~e)^-1), 2)) + (~A*~e + ~B*~d)*(~A + ~B*((~x)^2))*((1//4)*((~A)^-1)*((~d)^-1)*((~e)^-1)*((~q)^-1)*(Sqrt(~a + ~c*((~x)^4))^-1))*EllipticPi(Cancel(-((~B*~d - ~A*~e)^2)*((1//4)*((~A)^-1)*((~B)^-1)*((~d)^-1)*((~e)^-1))), 2ArcTan(~q*~x), 2^-1)*Sqrt(((~A)^2)*(~a + ~c*((~x)^4))*(((~a)^-1)*((~A + ~B*((~x)^2))^-2))))
 end
...
@rule integrate((~A + ~B*((~x)^2))*(((~d + ~e*((~x)^2))^-1)*(Sqrt(~a + ~c*((~x)^4))^-1)), ~x) =>  if And(FreeQ(List(~a, ~c, ~d, ~e, ~A, ~B), ~x), NeQ(~a*((~e)^2) + ~c*((~d)^2), 0), NeQ(~c*((~d)^2) - ~a*((~e)^2), 0), NegQ(~c*((~a)^-1))) 
 ~B*((~e)^-1)*integrate(Sqrt(~a + ~c*((~x)^4))^-1, ~x) + ((~e)^-1)*(~A*~e - ~B*~d)*integrate(((~d + ~e*((~x)^2))*Sqrt(~a + ~c*((~x)^4)))^-1, ~x)
 end
...
@rule integrate(~Px*(((~d + ~e*((~x)^2))^-1)*(Sqrt(~a + ~b*((~x)^2) + ~c*((~x)^4))^-1)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e), ~x), PolyQ(~Px, ~x), NeQ((~b)^2 - 4 * ~a*~c, 0), NeQ(~a*((~e)^2) + ~c*((~d)^2) - ~b*~d*~e, 0)) 
 With(List(Set(~q, Expon(~Px, ~x))), Condition((((~c)^-1)*((~e)^-1)*((~q - 3)^-1))*integrate((~Px*~c*~e*(~q - 3) - (~d + ~e*((~x)^2))*(~a*(~q - 5) + ~c*(~q - 3)*((~x)^4) + ~b*(~q - 4)*((~x)^2))*((~x)^(~q - 6))*Coeff(~Px, ~x, ~q))*(((~d + ~e*((~x)^2))^-1)*(Sqrt(~a + ~b*((~x)^2) + ~c*((~x)^4))^-1)), ~x) + ((~x)^(~q - 5))*(((~c)^-1)*((~e)^-1)*((~q - 3)^-1))*Coeff(~Px, ~x, ~q)*Sqrt(~a + ~b*((~x)^2) + ~c*((~x)^4)), GtQ(~q, 4)))
 end

@rule integrate(~Px*(((~d + ~e*((~x)^2))^-1)*(Sqrt(~a + ~c*((~x)^4))^-1)), ~x) =>  if And(FreeQ(List(~a, ~c, ~d, ~e), ~x), PolyQ(~Px, ~x), NeQ(~a*((~e)^2) + ~c*((~d)^2), 0)) 
 With(List(Set(~q, Expon(~Px, ~x))), Condition((((~c)^-1)*((~e)^-1)*((~q - 3)^-1))*integrate((~Px*~c*~e*(~q - 3) - (~d + ~e*((~x)^2))*((~x)^(~q - 6))*(~a*(~q - 5) + ~c*(~q - 3)*((~x)^4))*Coeff(~Px, ~x, ~q))*(((~d + ~e*((~x)^2))^-1)*(Sqrt(~a + ~c*((~x)^4))^-1)), ~x) + ((~x)^(~q - 5))*(((~c)^-1)*((~e)^-1)*((~q - 3)^-1))*Coeff(~Px, ~x, ~q)*Sqrt(~a + ~c*((~x)^4)), GtQ(~q, 4)))
 end
