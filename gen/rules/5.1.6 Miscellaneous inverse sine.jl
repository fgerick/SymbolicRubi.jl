...
@rule integrate(sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2))), ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 2(((~d)^-1)*((~x)^-1)*(sqrt((~b)^-1)^-1))*sqrt(~Pi)*cos(~a*((1//2)*((~b)^-1)))*FresnelS(sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2)))*sqrt((~Pi*~b)^-1))*sin((1//2)*ArcCos(1 + ~d*((~x)^2))) - 2(((~d)^-1)*((~x)^-1))*(sin((1//2)*ArcCos(1 + ~d*((~x)^2)))^2)*sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2))) - 2(((~d)^-1)*((~x)^-1)*(sqrt((~b)^-1)^-1))*sqrt(~Pi)*sin(~a*((1//2)*((~b)^-1)))*sin((1//2)*ArcCos(1 + ~d*((~x)^2)))*FresnelC(sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2)))*sqrt((~Pi*~b)^-1))
 end
...
@rule integrate((~a + ~b*ArcCos(1 + ~d*((~x)^2)))^-1, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 ~x*(0.7071067811865475((~b)^-1)*(sqrt(-~d*((~x)^2))^-1))*cos(~a*((1//2)*((~b)^-1)))*CosIntegral((~a + ~b*ArcCos(1 + ~d*((~x)^2)))*((1//2)*((~b)^-1))) + ~x*(0.7071067811865475((~b)^-1)*(sqrt(-~d*((~x)^2))^-1))*sin(~a*((1//2)*((~b)^-1)))*SinIntegral((~a + ~b*ArcCos(1 + ~d*((~x)^2)))*((1//2)*((~b)^-1)))
 end

@rule integrate((~a + ~b*ArcCos(~d*((~x)^2) - 1))^-1, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 ~x*(0.7071067811865475((~b)^-1)*(sqrt(~d*((~x)^2))^-1))*sin(~a*((1//2)*((~b)^-1)))*CosIntegral((~a + ~b*ArcCos(~d*((~x)^2) - 1))*((1//2)*((~b)^-1))) - ~x*(0.7071067811865475((~b)^-1)*(sqrt(~d*((~x)^2))^-1))*cos(~a*((1//2)*((~b)^-1)))*SinIntegral((~a + ~b*ArcCos(~d*((~x)^2) - 1))*((1//2)*((~b)^-1)))
 end
...
@rule integrate(sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2)))^-1, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 -2(((~d)^-1)*((~x)^-1))*sqrt(~Pi*((~b)^-1))*cos(~a*((1//2)*((~b)^-1)))*sin((1//2)*ArcCos(1 + ~d*((~x)^2)))*FresnelC(sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2)))*sqrt((~Pi*~b)^-1)) - 2(((~d)^-1)*((~x)^-1))*sqrt(~Pi*((~b)^-1))*sin(~a*((1//2)*((~b)^-1)))*FresnelS(sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2)))*sqrt((~Pi*~b)^-1))*sin((1//2)*ArcCos(1 + ~d*((~x)^2)))
 end
...
@rule integrate((~a + ~b*ArcCos(1 + ~d*((~x)^2)))^((-3//1)*(1//2)), ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 (((~b)^-1)*((~d)^-1)*((~x)^-1)*(sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2)))^-1))*sqrt(-((~d)^2)*((~x)^4) - 2~d*((~x)^2)) + 2((~b)^((-3//1)*(1//2)))*(((~d)^-1)*((~x)^-1))*sqrt(~Pi)*cos(~a*((1//2)*((~b)^-1)))*FresnelS(sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2)))*sqrt((~Pi*~b)^-1))*sin((1//2)*ArcCos(1 + ~d*((~x)^2))) - 2((~b)^((-3//1)*(1//2)))*(((~d)^-1)*((~x)^-1))*sqrt(~Pi)*sin(~a*((1//2)*((~b)^-1)))*sin((1//2)*ArcCos(1 + ~d*((~x)^2)))*FresnelC(sqrt(~a + ~b*ArcCos(1 + ~d*((~x)^2)))*sqrt((~Pi*~b)^-1))
 end
...
@rule integrate((~a + ~b*ArcCos(1 + ~d*((~x)^2)))^-2, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 ((1//2)*((~b)^-1)*((~d)^-1)*((~x)^-1)*((~a + ~b*ArcCos(1 + ~d*((~x)^2)))^-1))*sqrt(-((~d)^2)*((~x)^4) - 2~d*((~x)^2)) + ~x*(0.35355339059327373((~b)^-2)*(sqrt(-~d*((~x)^2))^-1))*sin(~a*((1//2)*((~b)^-1)))*CosIntegral((~a + ~b*ArcCos(1 + ~d*((~x)^2)))*((1//2)*((~b)^-1))) - ~x*(0.35355339059327373((~b)^-2)*(sqrt(-~d*((~x)^2))^-1))*cos(~a*((1//2)*((~b)^-1)))*SinIntegral((~a + ~b*ArcCos(1 + ~d*((~x)^2)))*((1//2)*((~b)^-1)))
 end

@rule integrate((~a + ~b*ArcCos(~d*((~x)^2) - 1))^-2, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 ((1//2)*((~b)^-1)*((~d)^-1)*((~x)^-1)*((~a + ~b*ArcCos(~d*((~x)^2) - 1))^-1))*sqrt(2~d*((~x)^2) - ((~d)^2)*((~x)^4)) - ~x*(0.35355339059327373((~b)^-2)*(sqrt(~d*((~x)^2))^-1))*cos(~a*((1//2)*((~b)^-1)))*CosIntegral((~a + ~b*ArcCos(~d*((~x)^2) - 1))*((1//2)*((~b)^-1))) - ~x*(0.35355339059327373((~b)^-2)*(sqrt(~d*((~x)^2))^-1))*sin(~a*((1//2)*((~b)^-1)))*SinIntegral((~a + ~b*ArcCos(~d*((~x)^2) - 1))*((1//2)*((~b)^-1)))
 end
...
@rule integrate((~a + ~b*ArcCos(~u))*((~c + ~d*~x)^~m), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~m), ~x), NeQ(~m, -1), InverseFunctionFreeQ(~u, ~x), Not(FunctionOfQ((~c + ~d*~x)^(1 + ~m), ~u, ~x)), Not(FunctionOfExponentialQ(~u, ~x))) 
 ~b*(((~d)^-1)*((1 + ~m)^-1))*integrate(SimplifyIntegrand(((~c + ~d*~x)^(1 + ~m))*(sqrt(1 - ((~u)^2))^-1)*D(~u, ~x), ~x), ~x) + (~a + ~b*ArcCos(~u))*((~c + ~d*~x)^(1 + ~m))*(((~d)^-1)*((1 + ~m)^-1))
 end
