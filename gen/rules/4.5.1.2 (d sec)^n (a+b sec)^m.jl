...
@rule integrate(Sqrt(~a + ~b*csc(~e + ~f*~x))*csc(~e + ~f*~x), ~x) =>  if And(FreeQ(List(~a, ~b, ~e, ~f), ~x), EqQ((~a)^2 - ((~b)^2), 0)) 
...
@rule integrate((Sqrt(~a + ~b*csc(~e + ~f*~x))^-1)*Sqrt(~d*csc(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~d, ~e, ~f), ~x), EqQ((~a)^2 - ((~b)^2), 0), EqQ(~d - ~a*((~b)^-1), 0), GtQ(~a, 0)) 
 -(((~b)^-1)*((~f)^-1))*Sqrt(2)*Sqrt(~a)*Subst(integrate(Sqrt(1 + (~x)^2)^-1, ~x), ~x, ~b*((~a + ~b*Csc(~e + ~f*~x))^-1)*cot(~e + ~f*~x))
 end
...
@rule integrate(Sqrt(~a + ~b*csc(~e + ~f*~x))*csc(~e + ~f*~x), ~x) =>  if And(FreeQ(List(~a, ~b, ~e, ~f), ~x), NeQ((~a)^2 - ((~b)^2), 0)) 
 ~b*integrate((Sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*(1 + Csc(~e + ~f*~x))*Csc(~e + ~f*~x), ~x) + (~a - ~b)*integrate((Sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*Csc(~e + ~f*~x), ~x)
 end
...
@rule integrate((Sqrt(~a + ~b*csc(~e + ~f*~x))^-1)*(csc(~e + ~f*~x)^2), ~x) =>  if And(FreeQ(List(~a, ~b, ~e, ~f), ~x), NeQ((~a)^2 - ((~b)^2), 0)) 
 integrate((Sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*(1 + Csc(~e + ~f*~x))*Csc(~e + ~f*~x), ~x) - integrate((Sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*Csc(~e + ~f*~x), ~x)
 end
...
@rule integrate(((~d*csc(~e + ~f*~x))^((3//1)*(1//2)))*(Sqrt(~a + ~b*csc(~e + ~f*~x))^-1), ~x) =>  if And(FreeQ(List(~a, ~b, ~d, ~e, ~f), ~x), NeQ((~a)^2 - ((~b)^2), 0)) 
 ~d*(Sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*Sqrt(~b + ~a*sin(~e + ~f*~x))*Sqrt(~d*Csc(~e + ~f*~x))*integrate((Sqrt(~b + ~a*sin(~e + ~f*~x))*sin(~e + ~f*~x))^-1, ~x)
 end
...
@rule integrate((Sqrt(~a + ~b*csc(~e + ~f*~x))*csc(~e + ~f*~x))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~e, ~f), ~x), NeQ((~a)^2 - ((~b)^2), 0)) 
 -(((~a)^-1)*((~f)^-1))*Sqrt(~a + ~b*Csc(~e + ~f*~x))*cos(~e + ~f*~x) - ~b*((1//2)*((~a)^-1))*integrate((1 + Csc(~e + ~f*~x)^2)*(Sqrt(~a + ~b*Csc(~e + ~f*~x))^-1), ~x)
 end
