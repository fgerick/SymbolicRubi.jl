...
@rule integrate(~x*(((~a + ~b*((~x)^2))^(-(1//4)))*((~c + ~d*((~x)^2))^-1)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), EqQ(~b*~c - 2~a*~d, 0), PosQ(~a)) 
 -(0.7071067811865475((~d)^-1)*(Rt(~a, 4)^-1))*ArcTan((Rt(~a, 4)^2 - sqrt(~a + ~b*((~x)^2)))*(0.7071067811865475((~a + ~b*((~x)^2))^(-(1//4)))*(Rt(~a, 4)^-1))) - (0.7071067811865475((~d)^-1)*(Rt(~a, 4)^-1))*ArcTanh((Rt(~a, 4)^2 + sqrt(~a + ~b*((~x)^2)))*(0.7071067811865475((~a + ~b*((~x)^2))^(-(1//4)))*(Rt(~a, 4)^-1)))
 end
...
@rule integrate(((~x)^2)*(((~a + ~b*((~x)^2))^((-3//1)*(1//4)))*((~c + ~d*((~x)^2))^-1)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), EqQ(~b*~c - 2~a*~d, 0), NegQ(((~a)^-1)*((~b)^2))) 
 ~b*(0.7071067811865475((~a)^-1)*((~d)^-1)*(Rt(-((~a)^-1)*((~b)^2), 4)^-3))*ArcTanh(~x*(0.7071067811865475((~a + ~b*((~x)^2))^(-(1//4))))*Rt(-((~a)^-1)*((~b)^2), 4)) - ~b*(0.7071067811865475((~a)^-1)*((~d)^-1)*(Rt(-((~a)^-1)*((~b)^2), 4)^-3))*ArcTan(~x*(0.7071067811865475((~a + ~b*((~x)^2))^(-(1//4))))*Rt(-((~a)^-1)*((~b)^2), 4))
 end
...
@rule integrate(~x*(((~a + ~b*((~x)^3))^((-2//1)*(1//3)))*((~c + ~d*((~x)^3))^-1)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), NeQ(~b*~c - ~a*~d, 0)) 
 With(List(Set(~q, Rt(((~c)^-1)*(~b*~c - ~a*~d), 3))), ((1//6)*((~c)^-1)*((~q)^-2))*Log(~c + ~d*((~x)^3)) - ((1//2)*((~c)^-1)*((~q)^-2))*Log(~q*~x - ((~a + ~b*((~x)^3))^(3^-1))) - (0.5773502691896258((~c)^-1)*((~q)^-2))*ArcTan(0.5773502691896258(1 + 2~q*~x*((~a + ~b*((~x)^3))^(-(1//3))))))
 end
