...
@rule integrate(((~c + ~d*sin(~e + ~f*~x))^~n)*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0), LtQ(~n, -1), NeQ(3 + 2 * ~n, 0), IntegerQ(2 * ~n)) 
 (3 + 2 * ~n)*(~b*~c - ~a*~d)*((1//2)*((~b)^-1)*((1 + ~n)^-1)*(((~c)^2 - ((~d)^2))^-1))*integrate(((~c + ~d*sin(~e + ~f*~x))^(1 + ~n))*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x) + ((~c + ~d*sin(~e + ~f*~x))^(1 + ~n))*(~b*~c - ~a*~d)*(((~f)^-1)*((1 + ~n)^-1)*(((~c)^2 - ((~d)^2))^-1)*(Sqrt(~a + ~b*sin(~e + ~f*~x))^-1))*cos(~e + ~f*~x)
 end
...
@rule integrate((Sqrt(~a + ~b*sin(~e + ~f*~x))^-1)*Sqrt(~c + ~d*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
 ((~b)^-1)*(~b*~c - ~a*~d)*integrate((Sqrt(~a + ~b*sin(~e + ~f*~x))*Sqrt(~c + ~d*sin(~e + ~f*~x)))^-1, ~x) + ~d*((~b)^-1)*integrate((Sqrt(~c + ~d*sin(~e + ~f*~x))^-1)*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x)
 end
...
@rule integrate((Sqrt(~a + ~b*sin(~e + ~f*~x))*Sqrt(~d*sin(~e + ~f*~x)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~d, ~e, ~f), ~x), EqQ((~a)^2 - ((~b)^2), 0), EqQ(~d, ~a*((~b)^-1)), GtQ(~a, 0)) 
 -(((~f)^-1)*(Sqrt(~a)^-1))*Sqrt(2)*Subst(integrate(Sqrt(1 - ((~x)^2))^-1, ~x), ~x, ~b*((~a + ~b*sin(~e + ~f*~x))^-1)*cos(~e + ~f*~x))
 end
...
@rule integrate(((~a + ~b*sin(~e + ~f*~x))^((-3//1)*(1//2)))*((~c + ~d*sin(~e + ~f*~x))^((3//1)*(1//2))), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
 ((~b)^-2)*(~b*~c - ~a*~d)*integrate((((~a + ~b*sin(~e + ~f*~x))^((-3//1)*(1//2)))*(Sqrt(~c + ~d*sin(~e + ~f*~x))^-1))*Simp(~b*~c + ~a*~d + 2 * ~b*~d*sin(~e + ~f*~x), ~x), ~x) + ((~b)^-2)*((~d)^2)*integrate((Sqrt(~c + ~d*sin(~e + ~f*~x))^-1)*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x)
 end
...
@rule integrate((Sqrt(~c + ~d*sin(~e + ~f*~x))^-1)*Sqrt(~b*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~b, ~c, ~d, ~e, ~f), ~x), GtQ((~c)^2 - ((~d)^2), 0), PosQ(((~b)^-1)*(~c + ~d)), GtQ((~c)^2, 0)) 
 2 * ~c*(((~d)^-1)*((~f)^-1)*(Sqrt((~c)^2 - ((~d)^2))^-1))*Sqrt(1 - Csc(~e + ~f*~x))*tan(~e + ~f*~x)*EllipticPi((~c + ~d)*((~d)^-1), ArcSin((Sqrt(~b*sin(~e + ~f*~x))^-1)*(Rt(((~b)^-1)*(~c + ~d), 2)^-1)*Sqrt(~c + ~d*sin(~e + ~f*~x))), ((~c - ~d)^-1)*(-~c - ~d))*Sqrt(1 + Csc(~e + ~f*~x))*Rt(~b*(~c + ~d), 2)
 end

@rule integrate((Sqrt(~c + ~d*sin(~e + ~f*~x))^-1)*Sqrt(~b*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~b, ~c, ~d, ~e, ~f), ~x), NeQ((~c)^2 - ((~d)^2), 0), PosQ(((~b)^-1)*(~c + ~d))) 
 2 * ~b*(((~d)^-1)*((~f)^-1))*tan(~e + ~f*~x)*EllipticPi((~c + ~d)*((~d)^-1), ArcSin((Sqrt(~b*sin(~e + ~f*~x))^-1)*(Rt(((~b)^-1)*(~c + ~d), 2)^-1)*Sqrt(~c + ~d*sin(~e + ~f*~x))), ((~c - ~d)^-1)*(-~c - ~d))*Sqrt(~c*((~c + ~d)^-1)*(1 - Csc(~e + ~f*~x)))*Sqrt(~c*((~c - ~d)^-1)*(1 + Csc(~e + ~f*~x)))*Rt(((~b)^-1)*(~c + ~d), 2)
 end
...
@rule integrate((Sqrt(~c + ~d*sin(~e + ~f*~x))^-1)*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0), PosQ((~a + ~b)*((~c + ~d)^-1))) 
 2(~a + ~b*sin(~e + ~f*~x))*(((~d)^-1)*((~f)^-1)*(cos(~e + ~f*~x)^-1)*(Rt((~a + ~b)*((~c + ~d)^-1), 2)^-1))*EllipticPi(~b*(~c + ~d)*(((~d)^-1)*((~a + ~b)^-1)), ArcSin((Sqrt(~a + ~b*sin(~e + ~f*~x))^-1)*Sqrt(~c + ~d*sin(~e + ~f*~x))*Rt((~a + ~b)*((~c + ~d)^-1), 2)), (~c + ~d)*(~a - ~b)*(((~a + ~b)^-1)*((~c - ~d)^-1)))*Sqrt((~b*~c - ~a*~d)*(1 + sin(~e + ~f*~x))*(((~c - ~d)^-1)*((~a + ~b*sin(~e + ~f*~x))^-1)))*Sqrt((1 - sin(~e + ~f*~x))*(~a*~d - ~b*~c)*(((~c + ~d)^-1)*((~a + ~b*sin(~e + ~f*~x))^-1)))
 end
