...
@rule integrate((~d + ~e*((~x)^~n))*((~a + ~c*((~x)^~n2))^-1), ~x) =>  if And(FreeQ(List(~a, ~c, ~d, ~e), ~x), EqQ(~n2, 2~n), NeQ(~a*((~e)^2) + ~c*((~d)^2), 0), NeQ(~c*((~d)^2) - ~a*((~e)^2), 0), IGtQ((1//2)*~n, 0), PosQ(~a*~c)) 
 With(List(Set(~q, Rt(~a*((~c)^-1), 4))), (0.35355339059327373((~c)^-1)*((~q)^-3))*integrate((((~q)^2 + (~x)^~n + 1.4142135623730951~q*((~x)^((1//2)*~n)))^-1)*((~d - ~e*((~q)^2))*((~x)^((1//2)*~n)) + 1.4142135623730951~d*~q), ~x) + (0.35355339059327373((~c)^-1)*((~q)^-3))*integrate((((~q)^2 + (~x)^~n - 1.4142135623730951~q*((~x)^((1//2)*~n)))^-1)*(1.4142135623730951~d*~q - (~d - ~e*((~q)^2))*((~x)^((1//2)*~n))), ~x))
 end

@rule integrate((~d + ~e*((~x)^3))*((~a + ~c*((~x)^6))^-1), ~x) =>  if And(FreeQ(List(~a, ~c, ~d, ~e), ~x), NeQ(~a*((~e)^2) + ~c*((~d)^2), 0), PosQ(~c*((~a)^-1))) 
 With(List(Set(~q, Rt(~c*((~a)^-1), 6))), ((1//3)*((~a)^-1)*((~q)^-2))*integrate(((1 + ((~q)^2)*((~x)^2))^-1)*(~d*((~q)^2) - ~e*~x), ~x) + ((1//6)*((~a)^-1)*((~q)^-2))*integrate(((1 + ((~q)^2)*((~x)^2) + 1.7320508075688772~q*~x)^-1)*(~x*(~e + 1.7320508075688772~d*((~q)^3)) + 2~d*((~q)^2)), ~x) + ((1//6)*((~a)^-1)*((~q)^-2))*integrate(((1 + ((~q)^2)*((~x)^2) - 1.7320508075688772~q*~x)^-1)*(2~d*((~q)^2) - ~x*(1.7320508075688772~d*((~q)^3) - ~e)), ~x))
 end
