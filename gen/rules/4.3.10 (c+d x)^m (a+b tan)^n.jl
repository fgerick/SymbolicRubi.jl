...
@rule integrate((~c + ~d*~x)*sqrt(~a + ~b*tan(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), EqQ((~a)^2 + (~b)^2, 0)) 
 1.4142135623730951~b*~d*(((~f)^-1)*(Rt(~a, 2)^-1))*integrate(ArcTanh((0.7071067811865475(Rt(~a, 2)^-1))*sqrt(~a + ~b*tan(~e + ~f*~x))), ~x) - 1.4142135623730951~b*(~c + ~d*~x)*(((~f)^-1)*(Rt(~a, 2)^-1))*ArcTanh((0.7071067811865475(Rt(~a, 2)^-1))*sqrt(~a + ~b*tan(~e + ~f*~x)))
 end

@rule integrate((~c + ~d*~x)*sqrt(~a + ~b*tan(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ((~a)^2 + (~b)^2, 0)) 
 ~I*(~c + ~d*~x)*((~f)^-1)*ArcTanh((Rt(~a + ~I*~b, 2)^-1)*sqrt(~a + ~b*tan(~e + ~f*~x)))*Rt(~a + ~I*~b, 2) + ~I*~d*((~f)^-1)*Rt(~a - ~I*~b, 2)*integrate(ArcTanh((Rt(~a - ~I*~b, 2)^-1)*sqrt(~a + ~b*tan(~e + ~f*~x))), ~x) - ~I*(~c + ~d*~x)*((~f)^-1)*ArcTanh((Rt(~a - ~I*~b, 2)^-1)*sqrt(~a + ~b*tan(~e + ~f*~x)))*Rt(~a - ~I*~b, 2) - ~I*~d*((~f)^-1)*Rt(~a + ~I*~b, 2)*integrate(ArcTanh((Rt(~a + ~I*~b, 2)^-1)*sqrt(~a + ~b*tan(~e + ~f*~x))), ~x)
 end
...
@rule integrate((~c + ~d*~x)*(sqrt(~a + ~b*tan(~e + ~f*~x))^-1), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ((~a)^2 + (~b)^2, 0)) 
 ~I*~d*(((~f)^-1)*(Rt(~a - ~I*~b, 2)^-1))*integrate(ArcTanh((Rt(~a - ~I*~b, 2)^-1)*sqrt(~a + ~b*tan(~e + ~f*~x))), ~x) + ~I*(~c + ~d*~x)*(((~f)^-1)*(Rt(~a + ~I*~b, 2)^-1))*ArcTanh((Rt(~a + ~I*~b, 2)^-1)*sqrt(~a + ~b*tan(~e + ~f*~x))) - ~I*~d*(((~f)^-1)*(Rt(~a + ~I*~b, 2)^-1))*integrate(ArcTanh((Rt(~a + ~I*~b, 2)^-1)*sqrt(~a + ~b*tan(~e + ~f*~x))), ~x) - ~I*(~c + ~d*~x)*(((~f)^-1)*(Rt(~a - ~I*~b, 2)^-1))*ArcTanh((Rt(~a - ~I*~b, 2)^-1)*sqrt(~a + ~b*tan(~e + ~f*~x)))
 end
