...
@rule integrate(Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2))), ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 2(((~d)^-1)*((~x)^-1))*(Sinh((1//2)*ArcCosh(1 + ~d*((~x)^2)))^2)*Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2))) + (Cosh(~a*((1//2)*((~b)^-1))) + Sinh(~a*((1//2)*((~b)^-1))))*(((~d)^-1)*((~x)^-1))*Sqrt(~b)*Sqrt((1//2)*~Pi)*Erf((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2))))*Sinh((1//2)*ArcCosh(1 + ~d*((~x)^2))) - (Cosh(~a*((1//2)*((~b)^-1))) - Sinh(~a*((1//2)*((~b)^-1))))*(((~d)^-1)*((~x)^-1))*Sqrt(~b)*Sqrt((1//2)*~Pi)*Erfi((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2))))*Sinh((1//2)*ArcCosh(1 + ~d*((~x)^2)))
 end

@rule integrate(Sqrt(~a + ~b*ArcCosh(~d*((~x)^2) - 1)), ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 2(((~d)^-1)*((~x)^-1))*(Cosh((1//2)*ArcCosh(~d*((~x)^2) - 1))^2)*Sqrt(~a + ~b*ArcCosh(~d*((~x)^2) - 1)) - (Cosh(~a*((1//2)*((~b)^-1))) - Sinh(~a*((1//2)*((~b)^-1))))*(((~d)^-1)*((~x)^-1))*Sqrt(~b)*Sqrt((1//2)*~Pi)*Erfi((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(~d*((~x)^2) - 1)))*Cosh((1//2)*ArcCosh(~d*((~x)^2) - 1)) - (Cosh(~a*((1//2)*((~b)^-1))) + Sinh(~a*((1//2)*((~b)^-1))))*(((~d)^-1)*((~x)^-1))*Sqrt(~b)*Sqrt((1//2)*~Pi)*Erf((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(~d*((~x)^2) - 1)))*Cosh((1//2)*ArcCosh(~d*((~x)^2) - 1))
 end
...
@rule integrate((~a + ~b*ArcCosh(1 + ~d*((~x)^2)))^-1, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 ~x*(((~b)^-1)*(Sqrt(~d*((~x)^2))^-1)*(Sqrt(2)^-1))*Cosh(~a*((1//2)*((~b)^-1)))*CoshIntegral((~a + ~b*ArcCosh(1 + ~d*((~x)^2)))*((1//2)*((~b)^-1))) - ~x*(((~b)^-1)*(Sqrt(~d*((~x)^2))^-1)*(Sqrt(2)^-1))*Sinh(~a*((1//2)*((~b)^-1)))*SinhIntegral((~a + ~b*ArcCosh(1 + ~d*((~x)^2)))*((1//2)*((~b)^-1)))
 end

@rule integrate((~a + ~b*ArcCosh(~d*((~x)^2) - 1))^-1, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 ~x*(((~b)^-1)*(Sqrt(~d*((~x)^2))^-1)*(Sqrt(2)^-1))*Cosh(~a*((1//2)*((~b)^-1)))*SinhIntegral((~a + ~b*ArcCosh(~d*((~x)^2) - 1))*((1//2)*((~b)^-1))) - ~x*(((~b)^-1)*(Sqrt(~d*((~x)^2))^-1)*(Sqrt(2)^-1))*Sinh(~a*((1//2)*((~b)^-1)))*CoshIntegral((~a + ~b*ArcCosh(~d*((~x)^2) - 1))*((1//2)*((~b)^-1)))
 end

@rule integrate(Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2)))^-1, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 (Cosh(~a*((1//2)*((~b)^-1))) + Sinh(~a*((1//2)*((~b)^-1))))*(((~d)^-1)*((~x)^-1)*(Sqrt(~b)^-1))*Sqrt((1//2)*~Pi)*Erf((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2))))*Sinh((1//2)*ArcCosh(1 + ~d*((~x)^2))) + (Cosh(~a*((1//2)*((~b)^-1))) - Sinh(~a*((1//2)*((~b)^-1))))*(((~d)^-1)*((~x)^-1)*(Sqrt(~b)^-1))*Sqrt((1//2)*~Pi)*Erfi((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2))))*Sinh((1//2)*ArcCosh(1 + ~d*((~x)^2)))
 end
...
@rule integrate((~a + ~b*ArcCosh(1 + ~d*((~x)^2)))^((-3//1)*(1//2)), ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 (Cosh(~a*((1//2)*((~b)^-1))) - Sinh(~a*((1//2)*((~b)^-1))))*(((~b)^((-3//1)*(1//2)))*((~d)^-1)*((~x)^-1))*Sqrt((1//2)*~Pi)*Erfi((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2))))*Sinh((1//2)*ArcCosh(1 + ~d*((~x)^2))) - (((~b)^-1)*((~d)^-1)*((~x)^-1)*(Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2)))^-1))*Sqrt(2 + ~d*((~x)^2))*Sqrt(~d*((~x)^2)) - (Cosh(~a*((1//2)*((~b)^-1))) + Sinh(~a*((1//2)*((~b)^-1))))*(((~b)^((-3//1)*(1//2)))*((~d)^-1)*((~x)^-1))*Sqrt((1//2)*~Pi)*Erf((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(1 + ~d*((~x)^2))))*Sinh((1//2)*ArcCosh(1 + ~d*((~x)^2)))
 end

@rule integrate((~a + ~b*ArcCosh(~d*((~x)^2) - 1))^((-3//1)*(1//2)), ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 (Cosh(~a*((1//2)*((~b)^-1))) + Sinh(~a*((1//2)*((~b)^-1))))*(((~b)^((-3//1)*(1//2)))*((~d)^-1)*((~x)^-1))*Sqrt((1//2)*~Pi)*Erf((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(~d*((~x)^2) - 1)))*Cosh((1//2)*ArcCosh(~d*((~x)^2) - 1)) + (Cosh(~a*((1//2)*((~b)^-1))) - Sinh(~a*((1//2)*((~b)^-1))))*(((~b)^((-3//1)*(1//2)))*((~d)^-1)*((~x)^-1))*Sqrt((1//2)*~Pi)*Erfi((Sqrt(2 * ~b)^-1)*Sqrt(~a + ~b*ArcCosh(~d*((~x)^2) - 1)))*Cosh((1//2)*ArcCosh(~d*((~x)^2) - 1)) - (((~b)^-1)*((~d)^-1)*((~x)^-1)*(Sqrt(~a + ~b*ArcCosh(~d*((~x)^2) - 1))^-1))*Sqrt(~d*((~x)^2) - 2)*Sqrt(~d*((~x)^2))
 end

@rule integrate((~a + ~b*ArcCosh(1 + ~d*((~x)^2)))^-2, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 ~x*((1//2)*((~b)^-2)*(Sqrt(~d*((~x)^2))^-1)*(Sqrt(2)^-1))*Cosh(~a*((1//2)*((~b)^-1)))*SinhIntegral((~a + ~b*ArcCosh(1 + ~d*((~x)^2)))*((1//2)*((~b)^-1))) - ((1//2)*((~b)^-1)*((~d)^-1)*((~x)^-1)*((~a + ~b*ArcCosh(1 + ~d*((~x)^2)))^-1))*Sqrt(2 + ~d*((~x)^2))*Sqrt(~d*((~x)^2)) - ~x*((1//2)*((~b)^-2)*(Sqrt(~d*((~x)^2))^-1)*(Sqrt(2)^-1))*Sinh(~a*((1//2)*((~b)^-1)))*CoshIntegral((~a + ~b*ArcCosh(1 + ~d*((~x)^2)))*((1//2)*((~b)^-1)))
 end

@rule integrate((~a + ~b*ArcCosh(~d*((~x)^2) - 1))^-2, ~x) =>  if FreeQ(List(~a, ~b, ~d), ~x) 
 ~x*((1//2)*((~b)^-2)*(Sqrt(~d*((~x)^2))^-1)*(Sqrt(2)^-1))*Cosh(~a*((1//2)*((~b)^-1)))*CoshIntegral((~a + ~b*ArcCosh(~d*((~x)^2) - 1))*((1//2)*((~b)^-1))) - ((1//2)*((~b)^-1)*((~d)^-1)*((~x)^-1)*((~a + ~b*ArcCosh(~d*((~x)^2) - 1))^-1))*Sqrt(~d*((~x)^2) - 2)*Sqrt(~d*((~x)^2)) - ~x*((1//2)*((~b)^-2)*(Sqrt(~d*((~x)^2))^-1)*(Sqrt(2)^-1))*Sinh(~a*((1//2)*((~b)^-1)))*SinhIntegral((~a + ~b*ArcCosh(~d*((~x)^2) - 1))*((1//2)*((~b)^-1)))
 end
