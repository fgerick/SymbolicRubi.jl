...
@rule integrate((~c + ~d*~x)*(sqrt(~a + ~b*((~x)^3))^-1), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), PosQ(~a), EqQ(~b*((~c)^3) + 0.39230484541326405~a*((~d)^3), 0)) 
 With(List(Set(~r, Numer(Simplify(-0.7320508075688772~d*((~c)^-1)))), Set(~s, Denom(Simplify(-0.7320508075688772~d*((~c)^-1))))), 2~d*((~s)^3)*(((~a)^-1)*((~r)^-2)*((2.732050807568877~s + ~r*~x)^-1))*sqrt(~a + ~b*((~x)^3)) - 0.5176380902050416~d*~s*(~s + ~r*~x)*(3^(4^-1))*(((~r)^-2)*(sqrt(~a + ~b*((~x)^3))^-1)*(sqrt(~s*(~s + ~r*~x)*((2.732050807568877~s + ~r*~x)^-2))^-1))*sqrt(((~s)^2 + ((~r)^2)*((~x)^2) - ~r*~s*~x)*((2.732050807568877~s + ~r*~x)^-2))*EllipticE(ArcSin(((2.732050807568877~s + ~r*~x)^-1)*(~r*~x - 0.7320508075688772~s)), -13.928203230275509))
 end

@rule integrate((~c + ~d*~x)*(sqrt(~a + ~b*((~x)^3))^-1), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), PosQ(~a), NeQ(~b*((~c)^3) + 0.39230484541326405~a*((~d)^3), 0)) 
 With(List(Set(~r, Numer(Rt(~b*((~a)^-1), 3))), Set(~s, Denom(Rt(~b*((~a)^-1), 3)))), ~d*((~r)^-1)*integrate((~r*~x - 0.7320508075688772~s)*(sqrt(~a + ~b*((~x)^3))^-1), ~x) + ((~r)^-1)*(~c*~r + 0.7320508075688772~d*~s)*integrate(sqrt(~a + ~b*((~x)^3))^-1, ~x))
 end

@rule integrate((~c + ~d*~x)*(sqrt(~a + ~b*((~x)^3))^-1), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), NegQ(~a), EqQ(~b*((~c)^3) - 20.392304845413264~a*((~d)^3), 0)) 
 With(List(Set(~r, Numer(Simplify(2.732050807568877~d*((~c)^-1)))), Set(~s, Denom(Simplify(2.732050807568877~d*((~c)^-1))))), 2~d*((~s)^3)*(((~a)^-1)*((~r)^-2)*((~r*~x - 0.7320508075688772~s)^-1))*sqrt(~a + ~b*((~x)^3)) + 1.9318516525781366~d*~s*(~s + ~r*~x)*(3^(4^-1))*(((~r)^-2)*(sqrt(~a + ~b*((~x)^3))^-1)*(sqrt(-~s*(~s + ~r*~x)*((~r*~x - 0.7320508075688772~s)^-2))^-1))*sqrt(((~s)^2 + ((~r)^2)*((~x)^2) - ~r*~s*~x)*((~r*~x - 0.7320508075688772~s)^-2))*EllipticE(ArcSin(((~r*~x - 0.7320508075688772~s)^-1)*(2.732050807568877~s + ~r*~x)), -0.07179676972449123))
 end

@rule integrate((~c + ~d*~x)*(sqrt(~a + ~b*((~x)^3))^-1), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), NegQ(~a), NeQ(~b*((~c)^3) - 20.392304845413264~a*((~d)^3), 0)) 
 With(List(Set(~r, Numer(Rt(~b*((~a)^-1), 3))), Set(~s, Denom(Rt(~b*((~a)^-1), 3)))), ~d*((~r)^-1)*integrate((2.732050807568877~s + ~r*~x)*(sqrt(~a + ~b*((~x)^3))^-1), ~x) + ((~r)^-1)*(~c*~r - 2.732050807568877~d*~s)*integrate(sqrt(~a + ~b*((~x)^3))^-1, ~x))
 end

@rule integrate((~c + ~d*((~x)^4))*(sqrt(~a + ~b*((~x)^6))^-1), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), EqQ(0.7320508075688772~d + 2~c*(Rt(~b*((~a)^-1), 3)^2), 0)) 
 With(List(Set(~r, Numer(Rt(~b*((~a)^-1), 3))), Set(~s, Denom(Rt(~b*((~a)^-1), 3)))), 2.732050807568877~d*~x*((~s)^3)*((1//2)*((~a)^-1)*((~r)^-2)*((~s + 2.732050807568877~r*((~x)^2))^-1))*sqrt(~a + ~b*((~x)^6)) - ~d*~s*~x*(~s + ~r*((~x)^2))*(3^(4^-1))*((1//2)*((~r)^-2)*(sqrt(~a + ~b*((~x)^6))^-1)*(sqrt(~r*(~s + ~r*((~x)^2))*((~x)^2)*((~s + 2.732050807568877~r*((~x)^2))^-2))^-1))*sqrt(((~s)^2 + ((~r)^2)*((~x)^4) - ~r*~s*((~x)^2))*((~s + 2.732050807568877~r*((~x)^2))^-2))*EllipticE(ArcCos((~s - 0.7320508075688772~r*((~x)^2))*((~s + 2.732050807568877~r*((~x)^2))^-1)), 3.732050807568877*0.25))
 end

@rule integrate((~c + ~d*((~x)^4))*(sqrt(~a + ~b*((~x)^6))^-1), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), NeQ(0.7320508075688772~d + 2~c*(Rt(~b*((~a)^-1), 3)^2), 0)) 
 With(List(Set(~q, Rt(~b*((~a)^-1), 3))), ~d*((1//2)*((~q)^-2))*integrate((2((~q)^2)*((~x)^4) - 0.7320508075688772)*(sqrt(~a + ~b*((~x)^6))^-1), ~x) + (0.7320508075688772~d + 2~c*((~q)^2))*((1//2)*((~q)^-2))*integrate(sqrt(~a + ~b*((~x)^6))^-1, ~x))
 end

@rule integrate((~c + ~d*((~x)^2))*(sqrt(~a + ~b*((~x)^8))^-1), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), EqQ(~b*((~c)^4) - ~a*((~d)^4), 0)) 
 -~c*~d*((~x)^3)*(((1.8477590650225735~c - 1.8477590650225735~d*((~x)^2))^-1)*(sqrt(~a + ~b*((~x)^8))^-1))*sqrt(-((~c - ~d*((~x)^2))^2)*(((~c)^-1)*((~d)^-1)*((~x)^-2)))*sqrt(-(~a + ~b*((~x)^8))*((~d)^2)*(((~b)^-1)*((~c)^-2)*((~x)^-4)))*EllipticF(ArcSin((1//2)*sqrt((1.4142135623730951((~c)^2) + 1.4142135623730951((~d)^2)*((~x)^4) + 2~c*~d*((~x)^2))*(((~c)^-1)*((~d)^-1)*((~x)^-2)))), 0.8284271247461903)
 end
