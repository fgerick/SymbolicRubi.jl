...
@rule integrate((~g + ~h*~x)*(((~a + ~c*((~x)^2))^(-(1//3)))*((~d + ~f*((~x)^2))^-1)), ~x) =>  if And(FreeQ(List(~a, ~c, ~d, ~f, ~g, ~h), ~x), EqQ(~c*~d + 3~a*~f, 0), EqQ(~c*((~g)^2) + 9~a*((~h)^2), 0), GtQ(~a, 0)) 
 ~h*(((~a)^(-(1//3)))*((~f)^-1)*(2^((-5//1)*(1//3))))*Log(~d + ~f*((~x)^2)) + 1.7320508075688772~h*(((~a)^(-(1//3)))*((~f)^-1)*(2^((-2//1)*(1//3))))*ArcTan(1.7320508075688772^-1 - (0.5773502691896258((1 + 3~h*~x*((~g)^-1))^(-(1//3))))*((1 - 3~h*~x*((~g)^-1))^((2//1)*(1//3)))*(2^((2//1)*(1//3)))) - 3~h*(((~a)^(-(1//3)))*((~f)^-1)*(2^((-5//1)*(1//3))))*Log(((1 + 3~h*~x*((~g)^-1))^(3^-1))*(2^(3^-1)) + (1 - 3~h*~x*((~g)^-1))^((2//1)*(1//3)))
 end
...
@rule integrate((~g + ~h*~x)*(((~a + ~b*~x + ~c*((~x)^2))^(-(1//3)))*((~d + ~e*~x + ~f*((~x)^2))^-1)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f, ~g, ~h), ~x), EqQ(~c*~e - ~b*~f, 0), EqQ(~d*((~c)^2) - ~f*((~b)^2 - 3~a*~c), 0), EqQ(((~c)^2)*((~g)^2) + 9~a*~c*((~h)^2) - 2((~b)^2)*((~h)^2) - ~b*~c*~g*~h, 0), GtQ(-9~c*((~h)^2)*((2~c*~g - ~b*~h)^-2), 0)) 
 With(List(Set(~q, (-9~c*((~h)^2)*((2~c*~g - ~b*~h)^-2))^(3^-1))), ~h*~q*((1//2)*((~f)^-1))*Log(~d + ~e*~x + ~f*((~x)^2)) + 1.7320508075688772~h*~q*((~f)^-1)*ArcTan(1.7320508075688772^-1 - (0.5773502691896258((1 + 3~h*(~b + 2~c*~x)*((2~c*~g - ~b*~h)^-1))^(-(1//3))))*((1 - 3~h*(~b + 2~c*~x)*((2~c*~g - ~b*~h)^-1))^((2//1)*(1//3)))*(2^((2//1)*(1//3)))) - 3~h*~q*((1//2)*((~f)^-1))*Log(((1 + 3~h*(~b + 2~c*~x)*((2~c*~g - ~b*~h)^-1))^(3^-1))*(2^(3^-1)) + (1 - 3~h*(~b + 2~c*~x)*((2~c*~g - ~b*~h)^-1))^((2//1)*(1//3))))
 end
