...
@rule integrate((((~c + ~d*sin(~e + ~f*~x))^-1)*(Sqrt(~g*sin(~e + ~f*~x))^-1))*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f, ~g), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
 (~b*~c - ~a*~d)*(((~c)^-1)*((~g)^-1))*integrate((((~c + ~d*sin(~e + ~f*~x))^-1)*(Sqrt(~a + ~b*sin(~e + ~f*~x))^-1))*Sqrt(~g*sin(~e + ~f*~x)), ~x) + ~a*((~c)^-1)*integrate((Sqrt(~a + ~b*sin(~e + ~f*~x))*Sqrt(~g*sin(~e + ~f*~x)))^-1, ~x)
 end
...
@rule integrate((((~c + ~d*sin(~e + ~f*~x))^-1)*(sin(~e + ~f*~x)^-1))*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0)) 
 ~a*((~c)^-1)*integrate((sin(~e + ~f*~x)*Sqrt(~a + ~b*sin(~e + ~f*~x)))^-1, ~x) + ((~c)^-1)*(~b*~c - ~a*~d)*integrate(((~c + ~d*sin(~e + ~f*~x))*Sqrt(~a + ~b*sin(~e + ~f*~x)))^-1, ~x)
 end
...
@rule integrate((((~c + ~d*sin(~e + ~f*~x))^-1)*(Sqrt(~a + ~b*sin(~e + ~f*~x))^-1))*Sqrt(~g*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f, ~g), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
 2(((~f)^-1)*((~c + ~d)^-1)*(cot(~e + ~f*~x)^-1)*(Sqrt(~a + ~b*sin(~e + ~f*~x))^-1))*EllipticPi(2 * ~c*((~c + ~d)^-1), ArcSin((Sqrt(2)^-1)*Sqrt(1 - Csc(~e + ~f*~x))), 2 * ~a*((~a + ~b)^-1))*Sqrt((~b + ~a*Csc(~e + ~f*~x))*((~a + ~b)^-1))*Sqrt(-(cot(~e + ~f*~x)^2))*Sqrt(~g*sin(~e + ~f*~x))
 end
...
@rule integrate(((~c + ~d*sin(~e + ~f*~x))*sin(~e + ~f*~x)*Sqrt(~a + ~b*sin(~e + ~f*~x)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ((~a)^2 - ((~b)^2), 0)) 
 (((~c)^-1)*((~b*~c - ~a*~d)^-1))*integrate((~b*~c - ~a*~d - ~b*~d*sin(~e + ~f*~x))*((sin(~e + ~f*~x)^-1)*(Sqrt(~a + ~b*sin(~e + ~f*~x))^-1)), ~x) + ((~d)^2)*(((~c)^-1)*((~b*~c - ~a*~d)^-1))*integrate(((~c + ~d*sin(~e + ~f*~x))^-1)*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x)
 end

@rule integrate(((~c + ~d*sin(~e + ~f*~x))*sin(~e + ~f*~x)*Sqrt(~a + ~b*sin(~e + ~f*~x)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0)) 
 ((~c)^-1)*integrate((sin(~e + ~f*~x)*Sqrt(~a + ~b*sin(~e + ~f*~x)))^-1, ~x) - ~d*((~c)^-1)*integrate(((~c + ~d*sin(~e + ~f*~x))*Sqrt(~a + ~b*sin(~e + ~f*~x)))^-1, ~x)
 end
...
@rule integrate(((sin(~e + ~f*~x)^-1)*(Sqrt(~c + ~d*sin(~e + ~f*~x))^-1))*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), EqQ((~c)^2 - ((~d)^2), 0)) 
 ~a*((~c)^-1)*integrate(((sin(~e + ~f*~x)^-1)*(Sqrt(~a + ~b*sin(~e + ~f*~x))^-1))*Sqrt(~c + ~d*sin(~e + ~f*~x)), ~x) + ((~c)^-1)*(~b*~c - ~a*~d)*integrate((Sqrt(~a + ~b*sin(~e + ~f*~x))*Sqrt(~c + ~d*sin(~e + ~f*~x)))^-1, ~x)
 end
...
@rule integrate(((sin(~e + ~f*~x)^-1)*(Sqrt(~c + ~d*sin(~e + ~f*~x))^-1))*Sqrt(~a + ~b*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
 -2(~a + ~b*sin(~e + ~f*~x))*(((~c)^-1)*((~f)^-1)*(cos(~e + ~f*~x)^-1)*(Rt((~a + ~b)*((~c + ~d)^-1), 2)^-1))*EllipticPi(~a*(~c + ~d)*(((~c)^-1)*((~a + ~b)^-1)), ArcSin((Sqrt(~a + ~b*sin(~e + ~f*~x))^-1)*Sqrt(~c + ~d*sin(~e + ~f*~x))*Rt((~a + ~b)*((~c + ~d)^-1), 2)), (~c + ~d)*(~a - ~b)*(((~a + ~b)^-1)*((~c - ~d)^-1)))*Sqrt((~b*~c - ~a*~d)*(1 + sin(~e + ~f*~x))*(((~c - ~d)^-1)*((~a + ~b*sin(~e + ~f*~x))^-1)))*Sqrt((1 - sin(~e + ~f*~x))*(~a*~d - ~b*~c)*(((~c + ~d)^-1)*((~a + ~b*sin(~e + ~f*~x))^-1)))
 end

@rule integrate((sin(~e + ~f*~x)*Sqrt(~a + ~b*sin(~e + ~f*~x))*Sqrt(~c + ~d*sin(~e + ~f*~x)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ((~a)^2 - ((~b)^2), 0), EqQ((~c)^2 - ((~d)^2), 0)) 
 ((Sqrt(~a + ~b*sin(~e + ~f*~x))^-1)*(Sqrt(~c + ~d*sin(~e + ~f*~x))^-1))*cos(~e + ~f*~x)*integrate((cos(~e + ~f*~x)*sin(~e + ~f*~x))^-1, ~x)
 end

@rule integrate((sin(~e + ~f*~x)*Sqrt(~a + ~b*sin(~e + ~f*~x))*Sqrt(~c + ~d*sin(~e + ~f*~x)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), Or(NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0))) 
