...
@rule integrate((sqrt(~a + ~b*csc(~e + ~f*~x))^-1)*sqrt(~c + ~d*csc(~e + ~f*~x))*csc(~e + ~f*~x), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), EqQ(~b*~c + ~a*~d, 0), EqQ((~a)^2 - ((~b)^2), 0)) 
...
@rule integrate(((~c + ~d*csc(~e + ~f*~x))^-1)*sqrt(~a + ~b*csc(~e + ~f*~x))*sqrt(~g*csc(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f, ~g), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0)) 
 ~a*((~c)^-1)*integrate((sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*sqrt(~g*Csc(~e + ~f*~x)), ~x) + (~b*~c - ~a*~d)*(((~c)^-1)*((~g)^-1))*integrate(((~g*Csc(~e + ~f*~x))^((3//1)*(1//2)))*(((~c + ~d*Csc(~e + ~f*~x))^-1)*(sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)), ~x)
 end

@rule integrate(((~c + ~d*csc(~e + ~f*~x))^-1)*csc(~e + ~f*~x)*sqrt(~a + ~b*csc(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ((~a)^2 - ((~b)^2), 0)) 
 -2~b*((~f)^-1)*Subst(integrate((~b*~c + ~a*~d + ~d*((~x)^2))^-1, ~x), ~x, ~b*(sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*cot(~e + ~f*~x))
 end

@rule integrate(((~c + ~d*csc(~e + ~f*~x))^-1)*csc(~e + ~f*~x)*sqrt(~a + ~b*csc(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), EqQ((~c)^2 - ((~d)^2), 0)) 
...
@rule integrate(((~c + ~d*csc(~e + ~f*~x))^-1)*csc(~e + ~f*~x)*sqrt(~a + ~b*csc(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
...
@rule integrate((((~c + ~d*csc(~e + ~f*~x))^-1)*(sqrt(~a + ~b*csc(~e + ~f*~x))^-1))*csc(~e + ~f*~x), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
 -2(((~f)^-1)*((~c + ~d)^-1)*(sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*(sqrt(-(cot(~e + ~f*~x)^2))^-1))*cot(~e + ~f*~x)*sqrt((~a + ~b*Csc(~e + ~f*~x))*((~a + ~b)^-1))*EllipticPi(2~d*((~c + ~d)^-1), ArcSin(0.7071067811865475sqrt(1 - Csc(~e + ~f*~x))), 2~b*((~a + ~b)^-1))
 end
...
@rule integrate((sqrt(~c + ~d*csc(~e + ~f*~x))^-1)*csc(~e + ~f*~x)*sqrt(~a + ~b*csc(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
 -2~b*((~f)^-1)*Subst(integrate((1 - ~b*~d*((~x)^2))^-1, ~x), ~x, ((sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*(sqrt(~c + ~d*Csc(~e + ~f*~x))^-1))*cot(~e + ~f*~x))
 end

@rule integrate((sqrt(~c + ~d*csc(~e + ~f*~x))^-1)*csc(~e + ~f*~x)*sqrt(~a + ~b*csc(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), EqQ((~c)^2 - ((~d)^2), 0)) 
...
@rule integrate((sqrt(~c + ~d*csc(~e + ~f*~x))^-1)*csc(~e + ~f*~x)*sqrt(~a + ~b*csc(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
 -2(~a + ~b*Csc(~e + ~f*~x))*(((~d)^-1)*((~f)^-1)*(cot(~e + ~f*~x)^-1)*(sqrt((~a + ~b)*((~c + ~d)^-1))^-1))*sqrt((1 - Csc(~e + ~f*~x))*(~a*~d - ~b*~c)*(((~c + ~d)^-1)*((~a + ~b*Csc(~e + ~f*~x))^-1)))*sqrt((~b*~c - ~a*~d)*(1 + Csc(~e + ~f*~x))*(((~c - ~d)^-1)*((~a + ~b*Csc(~e + ~f*~x))^-1)))*EllipticPi(~b*(~c + ~d)*(((~d)^-1)*((~a + ~b)^-1)), ArcSin((sqrt(~a + ~b*Csc(~e + ~f*~x))^-1)*sqrt(~c + ~d*Csc(~e + ~f*~x))*sqrt((~a + ~b)*((~c + ~d)^-1))), (~c + ~d)*(~a - ~b)*(((~a + ~b)^-1)*((~c - ~d)^-1)))
 end
...
@rule integrate(((~c + ~d*csc(~e + ~f*~x))^((-3//1)*(1//2)))*csc(~e + ~f*~x)*sqrt(~a + ~b*csc(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d, ~e, ~f), ~x), NeQ(~b*~c - ~a*~d, 0), NeQ((~a)^2 - ((~b)^2), 0), NeQ((~c)^2 - ((~d)^2), 0)) 
