...
@rule integrate(((~c + ~d*((~x)^3))*((~a + ~b*((~x)^3))^(3^-1)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), NeQ(~b*~c - ~a*~d, 0)) 
 With(List(Set(~q, Rt(((~c)^-1)*(~b*~c - ~a*~d), 3))), ((1//6)*((~c)^-1)*((~q)^-1))*Log(~c + ~d*((~x)^3)) + (0.5773502691896258((~c)^-1)*((~q)^-1))*ArcTan(0.5773502691896258(1 + 2~q*~x*((~a + ~b*((~x)^3))^(-(1//3))))) - ((1//2)*((~c)^-1)*((~q)^-1))*Log(~q*~x - ((~a + ~b*((~x)^3))^(3^-1))))
 end
...
@rule integrate(((~c + ~d*((~x)^2))*((~a + ~b*((~x)^2))^(3^-1)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ(~b*~c + 3~a*~d, 0), PosQ(~b*((~a)^-1))) 
 With(List(Set(~q, Rt(~b*((~a)^-1), 2))), ~q*((1//6)*((~a)^(-(1//3)))*((~d)^-1)*(2^((-2//1)*(1//3))))*ArcTan(~q*~x) + ~q*(0.2886751345948129((~a)^(-(1//3)))*((~d)^-1)*(2^((-2//1)*(1//3))))*ArcTanh(1.7320508075688772(((~q)^-1)*((~x)^-1))) + ~q*(0.2886751345948129((~a)^(-(1//3)))*((~d)^-1)*(2^((-2//1)*(1//3))))*ArcTanh(1.7320508075688772((~a)^(3^-1) - ((~a + ~b*((~x)^2))^(3^-1))*(2^(3^-1)))*(((~a)^(-(1//3)))*((~q)^-1)*((~x)^-1))) - ~q*((1//2)*((~a)^(-(1//3)))*((~d)^-1)*(2^((-2//1)*(1//3))))*ArcTan(~q*~x*((~a)^(3^-1))*(((~a)^(3^-1) + ((~a + ~b*((~x)^2))^(3^-1))*(2^(3^-1)))^-1)))
 end

@rule integrate(((~c + ~d*((~x)^2))*((~a + ~b*((~x)^2))^(3^-1)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ(~b*~c + 3~a*~d, 0), NegQ(~b*((~a)^-1))) 
 With(List(Set(~q, Rt(-~b*((~a)^-1), 2))), ~q*(0.2886751345948129((~a)^(-(1//3)))*((~d)^-1)*(2^((-2//1)*(1//3))))*ArcTan(1.7320508075688772(((~q)^-1)*((~x)^-1))) + ~q*(0.2886751345948129((~a)^(-(1//3)))*((~d)^-1)*(2^((-2//1)*(1//3))))*ArcTan(1.7320508075688772((~a)^(3^-1) - ((~a + ~b*((~x)^2))^(3^-1))*(2^(3^-1)))*(((~a)^(-(1//3)))*((~q)^-1)*((~x)^-1))) + ~q*((1//2)*((~a)^(-(1//3)))*((~d)^-1)*(2^((-2//1)*(1//3))))*ArcTanh(~q*~x*((~a)^(3^-1))*(((~a)^(3^-1) + ((~a + ~b*((~x)^2))^(3^-1))*(2^(3^-1)))^-1)) - ~q*((1//6)*((~a)^(-(1//3)))*((~d)^-1)*(2^((-2//1)*(1//3))))*ArcTanh(~q*~x))
 end

@rule integrate(((~c + ~d*((~x)^2))*((~a + ~b*((~x)^2))^(3^-1)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ(~b*~c - 9~a*~d, 0), PosQ(~b*((~a)^-1))) 
 With(List(Set(~q, Rt(~b*((~a)^-1), 2))), ~q*((1//12)*((~d)^-1)*(Rt(~a, 3)^-1))*ArcTan(((Rt(~a, 3) - ((~a + ~b*((~x)^2))^(3^-1)))^2)*((1//3)*((~q)^-1)*((~x)^-1)*(Rt(~a, 3)^-2))) + ~q*((1//12)*((~d)^-1)*(Rt(~a, 3)^-1))*ArcTan((1//3)*~q*~x) - ~q*(0.14433756729740646((~d)^-1)*(Rt(~a, 3)^-1))*ArcTanh((1.7320508075688772Rt(~a, 3) - 1.7320508075688772((~a + ~b*((~x)^2))^(3^-1)))*(((~q)^-1)*((~x)^-1)*(Rt(~a, 3)^-1))))
 end

@rule integrate(((~c + ~d*((~x)^2))*((~a + ~b*((~x)^2))^(3^-1)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), NeQ(~b*~c - ~a*~d, 0), EqQ(~b*~c - 9~a*~d, 0), NegQ(~b*((~a)^-1))) 
 With(List(Set(~q, Rt(-~b*((~a)^-1), 2))), ~q*((1//12)*((~d)^-1)*(Rt(~a, 3)^-1))*ArcTanh(((Rt(~a, 3) - ((~a + ~b*((~x)^2))^(3^-1)))^2)*((1//3)*((~q)^-1)*((~x)^-1)*(Rt(~a, 3)^-2))) - ~q*((1//12)*((~d)^-1)*(Rt(~a, 3)^-1))*ArcTanh((1//3)*~q*~x) - ~q*(0.14433756729740646((~d)^-1)*(Rt(~a, 3)^-1))*ArcTan((1.7320508075688772Rt(~a, 3) - 1.7320508075688772((~a + ~b*((~x)^2))^(3^-1)))*(((~q)^-1)*((~x)^-1)*(Rt(~a, 3)^-1))))
 end
...
@rule integrate(((~c + ~d*((~x)^2))*((~a + ~b*((~x)^2))^(4^-1)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), EqQ(~b*~c - 2~a*~d, 0), NegQ(((~a)^-1)*((~b)^2))) 
 With(List(Set(~q, Rt(-((~a)^-1)*((~b)^2), 4))), ~b*(0.35355339059327373((~a)^-1)*((~d)^-1)*((~q)^-1))*ArcTan(~q*~x*(0.7071067811865475((~a + ~b*((~x)^2))^(-(1//4))))) + ~b*(0.35355339059327373((~a)^-1)*((~d)^-1)*((~q)^-1))*ArcTanh(~q*~x*(0.7071067811865475((~a + ~b*((~x)^2))^(-(1//4))))))
 end
...
@rule integrate((sqrt(~c + ~d*((~x)^2))^-1)*sqrt(~a + ~b*((~x)^2)), ~x) =>  if And(FreeQ(List(~a, ~b, ~c, ~d), ~x), PosQ(~d*((~c)^-1)), PosQ(~b*((~a)^-1))) 
 ~a*integrate((sqrt(~a + ~b*((~x)^2))*sqrt(~c + ~d*((~x)^2)))^-1, ~x) + ~b*integrate(((~x)^2)*((sqrt(~a + ~b*((~x)^2))^-1)*(sqrt(~c + ~d*((~x)^2))^-1)), ~x)
 end
