...
@rule integrate((sqrt(~g*cos(~e + ~f*~x))^-1)*sqrt(~a + ~b*sin(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~e, ~f, ~g), ~x), EqQ((~a)^2 - ((~b)^2), 0)) 
 ~b*((~a + ~a*cos(~e + ~f*~x) + ~b*sin(~e + ~f*~x))^-1)*sqrt(~a + ~b*sin(~e + ~f*~x))*sqrt(1 + cos(~e + ~f*~x))*integrate(((sqrt(1 + cos(~e + ~f*~x))^-1)*(sqrt(~g*cos(~e + ~f*~x))^-1))*sin(~e + ~f*~x), ~x) + ~a*((~a + ~a*cos(~e + ~f*~x) + ~b*sin(~e + ~f*~x))^-1)*sqrt(~a + ~b*sin(~e + ~f*~x))*sqrt(1 + cos(~e + ~f*~x))*integrate((sqrt(~g*cos(~e + ~f*~x))^-1)*sqrt(1 + cos(~e + ~f*~x)), ~x)
 end
...
@rule integrate((sqrt(~a + ~b*sin(~e + ~f*~x))^-1)*sqrt(~g*cos(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~e, ~f, ~g), ~x), EqQ((~a)^2 - ((~b)^2), 0)) 
 ~g*((~a + ~a*cos(~e + ~f*~x) + ~b*sin(~e + ~f*~x))^-1)*sqrt(~a + ~b*sin(~e + ~f*~x))*sqrt(1 + cos(~e + ~f*~x))*integrate((sqrt(~g*cos(~e + ~f*~x))^-1)*sqrt(1 + cos(~e + ~f*~x)), ~x) - ~g*((~b + ~b*cos(~e + ~f*~x) + ~a*sin(~e + ~f*~x))^-1)*sqrt(~a + ~b*sin(~e + ~f*~x))*sqrt(1 + cos(~e + ~f*~x))*integrate(((sqrt(1 + cos(~e + ~f*~x))^-1)*(sqrt(~g*cos(~e + ~f*~x))^-1))*sin(~e + ~f*~x), ~x)
 end
...
@rule integrate((sqrt(~a + ~b*sin(~e + ~f*~x))*sqrt(~g*cos(~e + ~f*~x)))^-1, ~x) =>  if And(FreeQ(List(~a, ~b, ~e, ~f, ~g), ~x), NeQ((~a)^2 - ((~b)^2), 0)) 
 2.8284271247461903(((~f)^-1)*((~g)^-1)*(sqrt(~a + ~b*sin(~e + ~f*~x))^-1)*(sqrt((1 + cos(~e + ~f*~x) + sin(~e + ~f*~x))*((1 + cos(~e + ~f*~x) - sin(~e + ~f*~x))^-1))^-1))*sqrt(~g*cos(~e + ~f*~x))*sqrt((~a + ~b*sin(~e + ~f*~x))*(((~a - ~b)^-1)*((1 - sin(~e + ~f*~x))^-1)))*Subst(integrate(sqrt(1 + (~a + ~b)*((~x)^4)*((~a - ~b)^-1))^-1, ~x), ~x, sqrt((1 + cos(~e + ~f*~x) + sin(~e + ~f*~x))*((1 + cos(~e + ~f*~x) - sin(~e + ~f*~x))^-1)))
 end
...
@rule integrate(((~a + ~b*sin(~e + ~f*~x))^-1)*sqrt(~g*cos(~e + ~f*~x)), ~x) =>  if And(FreeQ(List(~a, ~b, ~e, ~f, ~g), ~x), NeQ((~a)^2 - ((~b)^2), 0)) 
 With(List(Set(~q, Rt((~b)^2 - ((~a)^2), 2))), ~b*~g*((~f)^-1)*Subst(integrate(((((~b)^2)*((~x)^2) + ((~g)^2)*((~a)^2 - ((~b)^2)))^-1)*sqrt(~x), ~x), ~x, ~g*cos(~e + ~f*~x)) + ~a*~g*((1//2)*((~b)^-1))*integrate(((~q + ~b*cos(~e + ~f*~x))*sqrt(~g*cos(~e + ~f*~x)))^-1, ~x) - ~a*~g*((1//2)*((~b)^-1))*integrate(((~q - ~b*cos(~e + ~f*~x))*sqrt(~g*cos(~e + ~f*~x)))^-1, ~x))
 end
